...
function x888889_Mail_ShiTuPrize( sceneId, selfId, param0, param1, param2, param3 )
	...
	if 40 == plevel then
		if 10 < c40+1 then
			x888889_NotifySystemMsg(sceneId,selfId,"Nh§n danh sß th¤t bÕi, ðã ðÕt t¾i thßþng hÕn.")
			return
		end
	elseif 50 == plevel then
		if 10 < c50+1 then
			x888889_NotifySystemMsg(sceneId,selfId,"Nh§n ð£c c¤p danh sß th¤t bÕi, ðã ðÕt t¾i thßþng hÕn.")
			return
		end
	end
	...
	if 1 == ret then
		...
		x888889_NotifySystemMsg(sceneId,selfId,"Nh§n tß·ng khoán thành công")
		--ÔÚ³é½±ÈÕÖ¾ÖÐ¼ÇÂ¼....
		...
		x888889_NotifySystemMsg(sceneId,selfId,"Tay näi #GNhi®m vø ðÕo cø#W cüa các hÕ thiªu không gian, nh§n th¤t bÕi.")
		return
	end
