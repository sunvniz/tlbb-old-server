...
local num = x808233_XinFaAddition( sceneId, selfId )
local nAddition = random(num)
	LuaFnSendSpecificImpactToUnit( sceneId, selfId, selfId, selfId, x808233_g_HieuUng[nAddition], 0 )
