--µÀ¾ß: Thiªu Lâm½õÄÒ<ID:30504008>
--½Å±¾ºÅ 889006
--Author: ÕÅ×³ 2008-9-22
...
x889006_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#c00FFFF#G#{_ITEM30504008}#c00FFFF, nhäy ra mµt cái #{_INFOMSG%s}#c00FFFF, a di ğà Ph§t, th§t ğáng m×ng.",
  "#{_INFOUSR%s}#c00FFFF#G#{_ITEM30504008}#c00FFFF, nhäy ra mµt cái #{_INFOMSG%s}#c00FFFF, a di ğà Ph§t, th§t ğáng m×ng.",
 	"#{_INFOUSR%s}#c00FFFF#G#{_ITEM30504008}#c00FFFF, nhäy ra mµt cái #{_INFOMSG%s}#c00FFFF, a di ğà Ph§t, th§t ğáng m×ng.",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒThiªu Lâm½õÄÒ×î¶à½±Àø5cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<4	
--ÒòÎªThiªu Lâm½õÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
