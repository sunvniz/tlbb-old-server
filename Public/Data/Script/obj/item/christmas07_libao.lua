...
function x300065_OnActivateOnce( sceneId, selfId )
	...
	--¸øKinh nghi®m....( 0.1*x*x + 6*x + 20 ) *15 *5....
	--7.5*x*x + 450*x +1500
	...
	--Èç¹û¸øtoÕ ğµ ĞúngÊ¥µ®Ã±....Ôò×ÔÊÊÓ¦µÈc¤p....Ç¿ÖÆ°ó¶¨....
	if GiftId == -999 then
	...
	--·¢Chúc m×ngÓÊ¼ş....
	if GiftId ~= 0 then
		LuaFnSendSystemMail(sceneId, GetName(sceneId, selfId), "    Chúc m×ng ngài ğÕt ğßşc l­ v§t Noel #Y#{_ITEM" ..GiftId.. "}#W.#r    [Thiên Long bát bµ] chúc ngài Noel vui vë. Nguy®n ngài cùng [Thiên Long bát bµ] cùng nhau khöe mÕnh trß·ng thành, cho nhau cùng n² lñc, hß¾ng ğªn t¯t ğ©p, tß½ng lai rñc rŞ.")
	end
