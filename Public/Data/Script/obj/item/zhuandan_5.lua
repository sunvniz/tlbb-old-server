...
x889004_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#c00FFFFNh© nhàng r¾t ra bäo hşp có nång lñc tiên nhân trong truy«n thuyªt, · bên trong phát hi®n mµt cái#{_INFOMSG%s}#c00FFFF!",
  "#{_INFOUSR%s}#c00FFFFNh© nhàng r¾t ra bäo hşp có nång lñc tiên nhân trong truy«n thuyªt, · bên trong phát hi®n mµt cái#{_INFOMSG%s}#c00FFFF!",
  "#{_INFOUSR%s}#c00FFFFNh© nhàng r¾t ra bäo hşp có nång lñc tiên nhân trong truy«n thuyªt, · bên trong phát hi®n mµt cái#{_INFOMSG%s}#c00FFFF!",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ
--ÒòÎª°Ù±¦ºĞ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸ÇÒÖ»ÓĞ1cái
--ËùÒÔ²»C¥n ¼ì²é¿Õ¼ä
