...
x889010_g_strGongGaoInfo = {
	"#{_INFOUSR%s}#c00FFFFTÕi khinh linh phiªu mi¬u s½n c¯c tìm ğßşc #G#{_ITEM30504012}#c00FFFF, r¾t ra v×a th¤y, mµt cái #{_INFOMSG%s}#c00FFFF · bên trong.",
  "#{_INFOUSR%s}#c00FFFFTÕi khinh linh phiªu mi¬u s½n c¯c tìm ğßşc #G#{_ITEM30504012}#c00FFFF, r¾t ra v×a th¤y, mµt cái #{_INFOMSG%s}#c00FFFF · bên trong.",
 	"#{_INFOUSR%s}#c00FFFFTÕi khinh linh phiªu mi¬u s½n c¯c tìm ğßşc #G#{_ITEM30504012}#c00FFFF, r¾t ra v×a th¤y, mµt cái #{_INFOMSG%s}#c00FFFF · bên trong.",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒTiêu Dao½õÄÒ×î¶à½±Àø5cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<4	
--ÒòÎªTiêu Dao½õÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
