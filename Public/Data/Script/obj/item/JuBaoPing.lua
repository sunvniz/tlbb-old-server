--µÀ¾ß: chìa khóa Âm Kim<ID:30008037>
--½Å±¾ºÅ 332203
...
x332203_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#HM· ra #G#{_ITEM30008037}#H, th§t sñ nhß nguy®n ğÕt ğßşc #{_INFOMSG%s}#H, th§t sñ là làm ngß¶i ta hâm mµ",
  "#{_INFOUSR%s}#HĞang th¥m oán #G#{_ITEM30008037}#H quá nhö, thª nhßng · bên trong phát hi®n mµt cái l¾n h½n næa #{_INFOMSG%s}!",
...
--ÒòÎª¾Û±¦Æ¿ĞúngÒªÏÈ±»ÏûºÄµôtoÕ ğµ ËùÒÔ²»ÓÃÅĞ¶ÏĞúng·ñC¥n ¿Õ¼ä	
