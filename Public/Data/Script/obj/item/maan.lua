--300044
-- V:\²ß»®ÎÄµµ\²ß»®ÎÄµtoÕ ðµ ¿Â¼½á¹¹\2 Éè¼ÆÎÄµµ\2.1 ÓÎÏ·µ¥Î»Éè¼Æ\ÌØ±ðÎïÆ·\ÈËÃñ±ÒÎïÆ·¡ª¡ªÂí°°.docx
-- 
-- 
...
function x300044_OnDefaultEvent( sceneId, selfId, nBagIndex )
	...
	local ret = 1
	if nCurCount >= 4  then
		-- ÅÐ¶ÏÏÂCái này ÎïÆ·toÕ ðµ IDÐúng²»ÐúngÕýÈ·ÏÈ
