...
function x300005_OnDefaultEvent( sceneId, selfId, BagIndex )
	...
	x300005_g_MissionCondition = GetMissionParam(sceneId,selfId,misIndex,0)		-- ’t ﬂ˛c»ŒŒÒ◊¥Ã¨
	scene = GetMissionParam(sceneId,selfId,misIndex,2)					-- ’t ﬂ˛c±¶ŒÔ≥°æ∞∫≈
	treasureX = GetMissionParam(sceneId,selfId,misIndex,3)					-- ’t ﬂ˛c±¶ŒÔX◊¯±Í
	treasureZ = GetMissionParam(sceneId,selfId,misIndex,4)				-- ’t ﬂ˛c±¶ŒÔZ◊¯±Í	
	--»Áπ˚»ŒŒÒ“—æ≠ÕÍ≥…
