--µÀ¾ß: Thiên Long½õÄÒ<ID:30504009>
--½Å±¾ºÅ 889007
--Author: ÕÅ×³ 2008-9-22
...
x889007_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#c00FFFF Ği kh¡p thiên nam ğ¸a b¡c, r¯t cøc · #G#{_ITEM30504009}#c00FFFF, tìm ğßşc r°i mµt cái #{_INFOMSG%s}#c00FFFF.",
 	"#{_INFOUSR%s}#c00FFFF Ği kh¡p thiên nam ğ¸a b¡c, r¯t cøc · #G#{_ITEM30504009}#c00FFFF, tìm ğßşc r°i mµt cái #{_INFOMSG%s}#c00FFFF.",
 	"#{_INFOUSR%s}#c00FFFF Ği kh¡p thiên nam ğ¸a b¡c, r¯t cøc · #G#{_ITEM30504009}#c00FFFF, tìm ğßşc r°i mµt cái #{_INFOMSG%s}#c00FFFF.",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒThiên Long½õÄÒ×î¶à½±Àø5cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<4	
--ÒòÎªThiên Long½õÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
