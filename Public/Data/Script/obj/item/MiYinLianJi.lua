...
function x300074_OnConditionCheck( sceneId, selfId )
	...
	if ItemCount < 1 then
		local strNotice = "#{MYKS_081021_2}" --ÃÜÒø¿óÊ¯¼ì²â
...
function x300074_OnActivateOnce( sceneId, selfId )
  ...
  --Êı¾İÍ³¼Æ: ÃÜÒøÈÜ¼ÁtoÕ ğµ Ê¹ÓÃ
	LuaFnAuditMiYinKuangShiUsed(sceneId, selfId)
	Msg2Player(sceneId, selfId, "#Các hÕ ğã nh§n ğßşc mµt cái#Hbí ngân c¤p 1", MSG2PLAYER_PARA )
