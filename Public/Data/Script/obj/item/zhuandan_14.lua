...
x889013_g_strGongGaoInfo = {
	"#c00FFFFTrong bäo kh¯ Cái Bang có ğü nhæng cái lÕ, c¥m #{_INFOUSR%s}#c00FFFF v×a mua, ğªn #G#{_ITEM30504015}#c00FFFF, quä nhiên tìm ğßşc mµt cái #{_INFOMSG%s}#c00FFFF.",
 	"#c00FFFFTrong bäo kh¯ Cái Bang có ğü nhæng cái lÕ, c¥m #{_INFOUSR%s}#c00FFFF v×a mua, ğªn #G#{_ITEM30504015}#c00FFFF, quä nhiên tìm ğßşc mµt cái #{_INFOMSG%s}#c00FFFF.",
  "#c00FFFFTrong bäo kh¯ Cái Bang có ğü nhæng cái lÕ, c¥m #{_INFOUSR%s}#c00FFFF v×a mua, ğªn #G#{_ITEM30504015}#c00FFFF, quä nhiên tìm ğßşc mµt cái #{_INFOMSG%s}#c00FFFF.",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒCái Bang½õÄÒ×î¶à½±Àø5cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<4	
--ÒòÎªCái Bang½õÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
