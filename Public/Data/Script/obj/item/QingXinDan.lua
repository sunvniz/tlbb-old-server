...
--½Å±¾ºÅ
x300055_g_scriptId = 300055 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x300055_g_Impact1 = 3151 --ÁÙÊ±Ğ´Cái này 
...
function x300055_OnDeplete( sceneId, selfId )
	if(0<LuaFnDepletingUsedItem(sceneId, selfId)) then		
		...
		local msg = format("Sát khí cüa các hÕ giäm 1 ği¬m, sát khí hi®n gi¶ cüa các hÕ là %d", nPkValue-1);
