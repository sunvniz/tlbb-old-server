...
function x332204_OnActivateOnce( sceneId, selfId )
	...
	if bagId >= 0 then
		...
		if UseValue >= x332204_g_MultiJuBaoPenMaxUseCount then   --¼ÇÂ¼toÕ ğµ Ê¹ÓÃ´ÎÊı´óÓÚµÈÓÚ×î´ó¿ÉÓÃ´ÎÊı,ÀíÂÛÉÏ²»¿ÉÄÜ³öÏÖ.
		    return 0
		end
