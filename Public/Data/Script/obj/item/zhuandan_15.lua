...
x889014_g_strGongGaoInfo = {
	"#{_INFOUSR%s}#c00FFFFTay c¥m #G#{_ITEM30504016}#c00FFFF, v×a lay ğµng chuy¬n v×a chuy¬n, ğang mu¯n súy mµt cái vòng tròn l¾n khi, hi®n ra mµt cái #{_INFOMSG%s}#c00FFFF.",
 	"#{_INFOUSR%s}#c00FFFFTay c¥m #G#{_ITEM30504016}#c00FFFF, v×a lay ğµng chuy¬n v×a chuy¬n, ğang mu¯n súy mµt cái vòng tròn l¾n khi, hi®n ra mµt cái #{_INFOMSG%s}#c00FFFF.",
  "#{_INFOUSR%s}#c00FFFFTay c¥m #G#{_ITEM30504016}#c00FFFF, v×a lay ğµng chuy¬n v×a chuy¬n, ğang mu¯n súy mµt cái vòng tròn l¾n khi, hi®n ra mµt cái #{_INFOMSG%s}#c00FFFF.",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒTinh Túc½õÄÒ×î¶à½±Àø5cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<4	
--ÒòÎªTinh Túc½õÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
