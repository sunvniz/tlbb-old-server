...
x889008_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#c00FFFF c¥m #G#{_ITEM30504010}#c00FFFF, nh¤t th¶i tâm d§p d¶n b°ng b«nh, khó th·, run lên mµt chút, hi®n ra mµt cái #{_INFOMSG%s}#c00FFFF.",
 	"#{_INFOUSR%s}#c00FFFF c¥m #G#{_ITEM30504010}#c00FFFF, nh¤t th¶i tâm d§p d¶n b°ng b«nh, khó th·, run lên mµt chút, hi®n ra mµt cái #{_INFOMSG%s}#c00FFFF.",
 	"#{_INFOUSR%s}#c00FFFF c¥m #G#{_ITEM30504010}#c00FFFF, nh¤t th¶i tâm d§p d¶n b°ng b«nh, khó th·, run lên mµt chút, hi®n ra mµt cái #{_INFOMSG%s}#c00FFFF.",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒ¶ëÃ¼½õÄÒ×î¶à½±Àø5cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<4	
--ÒòÎª¶ëÃ¼½õÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
