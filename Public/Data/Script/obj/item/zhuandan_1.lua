...
x889000_g_strGongGaoInfo = {
  "#{_INFOUSR%s}#c00FFFFNh© nhàng m· ra #G#{_ITEM30504001}#c00FFFF, rõ ràng m· ra #{_INFOMSG%s}#c00FFFF,#{_INFOUSR%s}#c00FFFF hô l¾n: Trân thú cüa ta!",
  "#{_INFOUSR%s}#c00FFFFNh© nhàng m· ra #G#{_ITEM30504001}#c00FFFF, rõ ràng m· ra #{_INFOMSG%s}#c00FFFF,#{_INFOUSR%s}#c00FFFF hô l¾n: Trân thú cüa ta!",
  "#{_INFOUSR%s}#c00FFFFNh© nhàng m· ra #G#{_ITEM30504001}#c00FFFF, rõ ràng m· ra #{_INFOMSG%s}#c00FFFF,#{_INFOUSR%s}#c00FFFF hô l¾n: Trân thú cüa ta!",
}
--**********************************
...
--ÒòÎª×ªµ°±¾ÉíÏûºÄmµt cái,»á¶à³ömµt cái¿Õ¸ñ,ÇÒÕäÊŞ±¦ÄÒ×î¶à½±Àø3cáiËùÒÔÅĞ¶ÏÊ£Óà¿Õ¼ä<2	
--ÒòÎªÕäÊŞ±¦ÄÒ½±ÀøÎïÆ·¶¼TÕi µÚmµt À¸
