...
function x001133_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x001133_g_scriptId, "Gi¾i thi®u sØa dung mÕo", 11, 1 )
		AddNumText(sceneId,x001133_g_scriptId,"SØa dung mÕ",6,2)

		AddNumText( sceneId, x001133_g_scriptId, "Gi¾i thi®u thay ð±i hình bi¬u tßþng nhân v§t", 11, 3 )
		AddNumText(sceneId,x001133_g_scriptId,"Thay ð±i hình bi¬u tßþng nhân v§t",6,4)
...
function x001133_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	elseif NumText == 4 then
		-- Thay ð±i hình bi¬u tßþng nhân v§t
