...
--Í­¿ó
--½Å±¾ºÅ710001
--Í­¿óÊ¯1	0.6		2	0.3		3	0.1		ºÚ±¦Ê¯1%
--ÒÔ20%¸ÅÂÊ ði¬mµ½¸±²úÆ·20103013,20103025,20103037,20103049 ÖÐtoÕ ðµ mµt ÖÖ,ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710001_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710001_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
