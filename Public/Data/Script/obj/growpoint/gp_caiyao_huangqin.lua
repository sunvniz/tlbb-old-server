...
--»ÆÜË
--½Å±¾ºÅ710507
--»ÆÜË1	0.6		2	0.3		3	0.1		Ö©Öë³öÏÖtoÕ ðµ ¸ÅÂÊÐúng0.2		ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710507_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710507_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
