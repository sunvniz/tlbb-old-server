...
--·ïÑª¿ó
--½Å±¾ºÅ710001
--·ïÑª¿óÊ¯1	0.6		2	0.3		3	0.1		Miêu Nhãn ThÕch1%
--ÒÔ20%¸ÅÂÊ ði¬mµ½¸±²úÆ·20103023,20103035,20103047,20103059 ÖÐtoÕ ðµ mµt ÖÖ,ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710011_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710011_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
