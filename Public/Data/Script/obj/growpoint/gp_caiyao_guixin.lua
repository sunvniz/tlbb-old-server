...
--¹ðÐÄ
--½Å±¾ºÅ710520
--¹ðÐÄ1	0.6		2	0.3		3	0.1		Òø»·Éß³öÏÖtoÕ ðµ ¸ÅÂÊÐúng0.2		ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710520_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710520_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
