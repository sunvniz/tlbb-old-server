...
--Ìú¿ó
--½Å±¾ºÅ710002
--Ìú¿óÊ¯1	0.6		2	0.3		3	0.1		»Æ±¦Ê¯1%
--ÒÔ20%¸ÅÂÊ ði¬mµ½¸±²úÆ·20103014,20103026,20103038,20103050 ÖÐtoÕ ðµ mµt ÖÖ,ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710002_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710002_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
