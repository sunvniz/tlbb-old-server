...
-- abilityId: Éú³¤ ði¬m¶ÔÓ¦¼¼ÄÜ name: Éú³¤ ði¬mtoÕ ðµ Tên
-- mainId: Ö÷Òªµô³öÎï mExtraCountOdds: Ö÷Òªµô³öÎï¶îÍâµô³öÊýÁ¿toÕ ðµ ¼¸ÂÊ
-- associatedId: ¸±²úÆ·ÁÐ±í,aOdds ¼¸ÂÊ³öÏÖÊ±Ëæ»ú³ömµt cái,ÁÐ±í¿ÉÒÔÎª¿Õ aOdds: ¸±²úÆ·µô³öÂÊ aExtraCountOdds: ³öÏÖ¸±²úÆ·ºó¶îÍâÊýÁ¿¼¸ÂÊ
-- rareId: Ï¡ÓÐÎïÆ·,Ï¡ÓÐÎïÆ·¿ÉÒÔÃ»ÓÐ,Ìî -1, rOdds: Ï¡ÓÐÎïÆ·µô³öÂÊ
-- needLevel: ²É¼¯´ËÉú³¤ ði¬mC¥n toÕ ðµ c¤p±ð

-- ÒÔÏÂ²¿·ÖÎª¿óÊ¯
x710000_g_GPInfo[1 ] = { abilityId = ABILITY_CAIKUANG, name = "Mö ð°ng",
	mainId = 20103001, mExtraCountOdds = { 10000, 5000, 1200, 200, 100 },	-- ±íÃ÷ 100% ¼¸ÂÊµôÂä,50% ¼¸ÂÊµô2cái,38% ¼¸ÂÊµôÈýcái,10% ¼¸ÂÊµôËÄcái,1% ¼¸ÂÊµôÎåcái,1% ¼¸ÂÊµôÁùcái,
...
x710000_g_GPInfo[13] = { abilityId = ABILITY_CAIKUANG, name = "Côn s½n qu£ng ng÷c",
...
function x710000_OnCreate( sceneId, growPointType, x, y )
	...
	-- hongyu Ìí¼Ó²É¼¯³ö¶mµt »Æó¶ìtoÕ ðµ ´úÂë
