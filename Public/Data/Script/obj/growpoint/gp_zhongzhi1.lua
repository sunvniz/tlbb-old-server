...
-- Éú³¤ ði¬mÀàÐÍºÅÎªË÷ÒýºÅ

-- NextGeneration: ¸ÃÉú³¤ ði¬m»ØÊÕºó³¤³ötoÕ ðµ ÐÂÉú³¤ ði¬mtoÕ ðµ ÀàÐÍ
...
function x711000_OnRecycle( sceneId, selfId, targetId )
	...
	local ItemBoxOwnerGUID = GetItemBoxOwner( sceneId, targetId )				--²ÎÊýÐúngSceneID,ItemBoxID
	--¸øItemBoxÉè¶¨Ö÷ÈË
