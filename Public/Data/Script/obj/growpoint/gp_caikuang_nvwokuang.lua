...
--Å®æ´Ê¯¿ó
--½Å±¾ºÅ710001
--Å®æ´Ê¯1	0.6		2	0.3		3	0.1		H± Nhãn ThÕch1%
--ÒÔ20%¸ÅÂÊ ði¬mµ½¸±²úÆ·20103024,20103036,20103048,20103060 ÖÐtoÕ ðµ mµt ÖÖ,ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710012_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710012_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
