...
--ÐþÌú¿ó
--½Å±¾ºÅ710001
--ÐþÌú¿óÊ¯1	0.6		2	0.3		3	0.1		»ÆÓñ1%
--ÒÔ20%¸ÅÂÊ ði¬mµ½¸±²úÆ·20103018,20103030,20103042,20103054 ÖÐtoÕ ðµ mµt ÖÖ,ÊýÁ¿1	0.6		2	0.3		3	0.1
--µÈc¤p1
...
function 		x710006_OnCreate(sceneId,growPointType,x,y)
	...
	targetId  = ItemBoxEnterScene(x,y,growPointType,sceneId,QUALITY_MUST_BE_CHANGE,1,x710006_g_MainItemId)	--Ã¿cáiÉú³¤ ði¬m×îÉÙÄÜ ði¬mµ½mµt cáiÎïÆ·,ÕâÀïÖ±½Ó·ÅÈëitemboxÖÐmµt cái
