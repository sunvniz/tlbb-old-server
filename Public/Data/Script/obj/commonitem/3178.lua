...
--½Å±¾ºÅ
x333178_g_scriptId = 333178 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333178_g_Impact1 = 3178 --ÁÙÊ±Ğ´Cái này 
x333178_g_Impact2 = -1 --²»ÓÃ
X333178_g_DepletedHp = 140 --ÏûºÄtoÕ ğµ ·¨Á¦
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x333178_OnDeplete( sceneId, selfId )
	...
	IncreaseHp(sceneId, selfId, -X333178_g_DepletedHp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
