...
--½Å±¾ºÅ
x333179_g_scriptId = 333179 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333179_g_Impact1 = 3179 --ÁÙÊ±Ğ´Cái này 
x333179_g_Impact2 = -1 --²»ÓÃ
X333179_g_DepletedHp = 200 --ÏûºÄtoÕ ğµ ·¨Á¦
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x333179_OnDeplete( sceneId, selfId )
	...
	IncreaseHp(sceneId, selfId, -X333179_g_DepletedHp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
