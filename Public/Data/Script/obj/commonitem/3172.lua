...
--½Å±¾ºÅ
x333172_g_scriptId = 333172 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333172_g_Impact1 = 3172 --ÁÙÊ±Ğ´Cái này 
x333172_g_Impact2 = -1 --²»ÓÃ
X333172_g_DepletedMp = 80 --ÏûºÄtoÕ ğµ ·¨Á¦
...
function x333172_OnDeplete( sceneId, selfId )
	...
	IncreaseMp(sceneId, selfId, -X333172_g_DepletedMp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
