...
--½Å±¾ºÅ
x333210_g_scriptId = 333210 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x333210_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x333210_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x333210_g_Impact1 = 3210 --ÁÙÊ±Ğ´Cái này 
x333210_g_Impact2 = -1 --²»ÓÃ
