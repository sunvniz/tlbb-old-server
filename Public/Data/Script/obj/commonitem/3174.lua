...
--½Å±¾ºÅ
x333174_g_scriptId = 333174 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333174_g_Impact1 = 3174 --ÁÙÊ±Ğ´Cái này 
x333174_g_Impact2 = -1 --²»ÓÃ
X333174_g_DepletedMp = 200 --ÏûºÄtoÕ ğµ ·¨Á¦
...
function x333174_OnDeplete( sceneId, selfId )
	...
	IncreaseMp(sceneId, selfId, -X333174_g_DepletedMp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
