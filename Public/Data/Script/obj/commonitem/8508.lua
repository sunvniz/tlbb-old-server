...
--½Å±¾ºÅ
x338508_g_scriptId = 338508 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x338508_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x338508_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x338508_g_Impact1 = 8508 --ÁÙÊ±Ğ´Cái này 
x338508_g_Impact2 = -1 --²»ÓÃ
