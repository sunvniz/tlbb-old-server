...
--½Å±¾ºÅ
 x335052_g_scriptId = 335052 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x335052_g_Equitation1 = 1088 --C¥n toÕ ðµ ÆïÊõ
 x335052_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x335052_g_Impact1 = 4712 --ÁÙÊ±Ð´Cái này 
