...
--½Å±¾ºÅ
x334140_g_scriptId = 334140 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x334140_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x334140_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x334140_g_Impact1 = 4140 --ÁÙÊ±Ğ´Cái này 
x334140_g_Impact2 = -1 --²»ÓÃ
