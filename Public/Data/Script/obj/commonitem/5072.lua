...
--½Å±¾ºÅ
 x335072_g_scriptId = 335072 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x335072_g_Equitation1 = 1103 --C¥n toÕ ðµ ÆïÊõ
 x335072_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x335072_g_Impact1 = 4728 --ÁÙÊ±Ð´Cái này 
