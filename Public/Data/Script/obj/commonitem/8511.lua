...
--		--BroadMsgByChatPipe(sceneId, selfId, "#{_INFOUSR"..PlayerName.."}#ccc33ccSØ døng #{_INFOMSG"..szTransferItem.."}", 4)
--		return 1;
--	end
	--Cái này ÎïÆ·Âß¼­ÌØÊâ.É¾³ıtoÕ ğµ µØ·½Ã»ÓĞÉ¾³ı,¶øĞúng×îºóÏûºÄºótoÕ ğµ º¯ÊıÖĞTÕi ¸ù¾İÌõ¼şÉ¾³ı.ÆäËûµØ·½²»Òª²Î¿¼ÕâÀïÌØÊâtoÕ ğµ ´¦Àí
...
function x338511_OnActivateOnce( sceneId, selfId )
    ...
    if ret == 1 then--TÕi ÕıÈ·toÕ ğµ Î»ÖÃSØ døng ÒıÄ§Öé,²ÅÉ¾³ı
