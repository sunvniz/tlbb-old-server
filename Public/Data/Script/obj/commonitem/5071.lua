...
--½Å±¾ºÅ
 x335071_g_scriptId = 335071 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x335071_g_Equitation1 = 1102 --C¥n toÕ ðµ ÆïÊõ
 x335071_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x335071_g_Impact1 = 4727 --ÁÙÊ±Ð´Cái này 
