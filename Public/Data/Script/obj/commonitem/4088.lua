...
--½Å±¾ºÅ
x334088_g_scriptId = 334088 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x334088_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x334088_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x334088_g_Impact1 = 4088 --ÁÙÊ±Ğ´Cái này 
x334088_g_Impact2 = -1 --²»ÓÃ
