...
--½Å±¾ºÅ
 x335100_g_scriptId = 335100 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x335100_g_Equitation1 = 1077 --C¥n toÕ ðµ ÆïÊõ
 x335100_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x335100_g_Impact1 = 5700 --ÁÙÊ±Ð´Cái này 
 x335100_g_Impact2 = -1 --²»ÓÃ
