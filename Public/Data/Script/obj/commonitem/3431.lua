...
--½Å±¾ºÅ
x333431_g_scriptId = 333431 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x333431_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x333431_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x333431_g_Impact1 = 3431 --ÁÙÊ±Ğ´Cái này 
x333431_g_Impact2 = 35 --²»ÓÃ  ´ò×ø»Ö¸´
