...
--½Å±¾ºÅ
x333173_g_scriptId = 333173 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333173_g_Impact1 = 3173 --ÁÙÊ±Ğ´Cái này 
x333173_g_Impact2 = -1 --²»ÓÃ
X333173_g_DepletedMp = 140 --ÏûºÄtoÕ ğµ ·¨Á¦
...
function x333173_OnDeplete( sceneId, selfId )
	...
	IncreaseMp(sceneId, selfId, -X333173_g_DepletedMp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
