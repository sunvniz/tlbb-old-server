...
--½Å±¾ºÅ
x333175_g_scriptId = 333175 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333175_g_Impact1 = 3175 --ÁÙÊ±Ğ´Cái này 
x333175_g_Impact2 = -1 --²»ÓÃ
X333175_g_DepletedMp = 300 --ÏûºÄtoÕ ğµ ·¨Á¦
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x333175_OnDeplete( sceneId, selfId )
	...
	IncreaseMp(sceneId, selfId, -X333175_g_DepletedMp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
