...
--½Å±¾ºÅ
 x334706_g_scriptId = 334706 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x334706_g_Equitation1 = 443 --C¥n toÕ ðµ ÆïÊõ
 x334706_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x334706_g_Impact1 = 4706 --ÁÙÊ±Ð´Cái này 
 x334706_g_Impact2 = -1 --²»ÓÃ
