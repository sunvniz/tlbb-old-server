...
--½Å±¾ºÅ
x334906_g_scriptId = 334906 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x334906_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x334906_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x334906_g_Impact1 = 4906 --ÁÙÊ±Ğ´Cái này 
x334906_g_Impact2 = -1 --²»ÓÃ
...
--		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, x334906_g_Impact1, 0);
		...
		if(0<=targetId) then
			if LuaFnIsFriend(sceneId, targetId, selfId) > 0 then
				...
				BeginEvent(sceneId)
			    AddText(sceneId, "ÄãÓë¶Ô·½toÕ ğµ ÓÑºÃ¶ÈÔö¼ÓÁË100");
			  EndEvent(sceneId)
