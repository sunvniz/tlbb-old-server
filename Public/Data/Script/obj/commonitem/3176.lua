...
--½Å±¾ºÅ
x333176_g_scriptId = 333176 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333176_g_Impact1 = 3176 --ÁÙÊ±Ğ´Cái này 
x333176_g_Impact2 = -1 --²»ÓÃ
X333176_g_DepletedHp = 20 --ÏûºÄtoÕ ğµ ·¨Á¦
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x333176_OnDeplete( sceneId, selfId )
	...
	IncreaseHp(sceneId, selfId, -X333176_g_DepletedHp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
