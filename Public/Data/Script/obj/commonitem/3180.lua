...
--½Å±¾ºÅ
x333180_g_scriptId = 333180 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333180_g_Impact1 = 3180 --ÁÙÊ±Ğ´Cái này 
x333180_g_Impact2 = -1 --²»ÓÃ
X333180_g_DepletedHp = 300 --ÏûºÄtoÕ ğµ ·¨Á¦
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x333180_OnDeplete( sceneId, selfId )
	...
	IncreaseHp(sceneId, selfId, -X333180_g_DepletedHp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
