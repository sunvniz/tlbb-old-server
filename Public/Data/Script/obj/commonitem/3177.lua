...
--½Å±¾ºÅ
x333177_g_scriptId = 333177 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333177_g_Impact1 = 3177 --ÁÙÊ±Ğ´Cái này 
x333177_g_Impact2 = -1 --²»ÓÃ
X333177_g_DepletedHp = 80 --ÏûºÄtoÕ ğµ ·¨Á¦
--**********************************
--ÊÂ¼ş½»»¥Èë¿Ú
--**********************************
...
function x333177_OnDeplete( sceneId, selfId )
	...
	IncreaseHp(sceneId, selfId, -X333177_g_DepletedHp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
