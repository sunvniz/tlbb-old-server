...
--½Å±¾ºÅ
x333171_g_scriptId = 333171 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.

--C¥n toÕ ğµ µÈc¤p

--Ğ§¹ûtoÕ ğµ ID
x333171_g_Impact1 = 3171 --ÁÙÊ±Ğ´Cái này 
x333171_g_Impact2 = -1 --²»ÓÃ
X333171_g_DepletedMp = 20 --ÏûºÄtoÕ ğµ ·¨Á¦
...
function x333171_OnDeplete( sceneId, selfId )
	...
	IncreaseMp(sceneId, selfId, -X333171_g_DepletedMp) --ÏûºÄµôÏàÓ¦toÕ ğµ MP
