...
--½Å±¾ºÅ
 x335023_g_scriptId = 335023 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x335023_g_Equitation1 = 1077 --C¥n toÕ ðµ ÆïÊõ
 x335023_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x335023_g_Impact1 = 5028 --ÁÙÊ±Ð´Cái này 
