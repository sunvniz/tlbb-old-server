...
--½Å±¾ºÅ
x334916_g_scriptId = 334916 --ÁÙÊ±Ğ´Cái này ,ÕæÕıÓÃtoÕ ğµ Ê±ºòmµt ¶¨Òª¸Ä.
...
x334916_g_standFlag = 1 -- 2:¶ÓÓÑ, 1: ÓÑ¾ü, -1: µĞ¾ü
--AEÓ°ÏìÊıÄ¿ÏŞÖÆ
x334916_g_effectCount = 4 -- -1:²»ÏŞÖÆ
--Ğ§¹ûtoÕ ğµ ID
x334916_g_Impact1 = 4916 --ÁÙÊ±Ğ´Cái này 
...
function x334916_OnDeplete( sceneId, selfId )
	...
	if(LuaFnDepletingUsedItem(sceneId, selfId)) then
		...
		if itmId > 0 then
			...
			local	str	= format( "#B#{_INFOUSR"..namSelf.."}#cff0000Ç×ÊÖ°Ñ#W["..namItem.."]#cff0000ËÍµ½#B#{_INFOUSR"..namTarget.."}#cff0000ÊÖÖĞ,ÉîÇéµØ¿´×Å#B#{_INFOUSR"..namTarget.."}#cff0000." )
...
--		LuaFnSendSpecificImpactToUnit(sceneId, selfId, selfId, selfId, x334916_g_Impact1, 0);
		...
		if(0<=targetId) then
			if LuaFnIsFriend(sceneId, targetId, selfId) > 0 then
				...
				BeginEvent(sceneId)
			    AddText(sceneId, "ÄãÓë¶Ô·½toÕ ğµ ÓÑºÃ¶ÈÔö¼ÓÁË50");
			  EndEvent(sceneId)
