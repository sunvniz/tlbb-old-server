...
--½Å±¾ºÅ
 x334704_g_scriptId = 334704 --ÁÙÊ±Ð´Cái này ,ÕæÕýÓÃtoÕ ðµ Ê±ºòmµt ¶¨Òª¸Ä.
...
--×¢: Á½cáiÆïÊõ»ámµt cái¾Í¿ÉÒÔÆïÁË
 x334704_g_Equitation1 = 433 --C¥n toÕ ðµ ÆïÊõ
 x334704_g_Equitation2 = -1 --C¥n toÕ ðµ ÆïÊõ
--Ð§¹ûtoÕ ðµ ID
 x334704_g_Impact1 = 4704 --ÁÙÊ±Ð´Cái này 
 x334704_g_Impact2 = -1 --²»ÓÃ
