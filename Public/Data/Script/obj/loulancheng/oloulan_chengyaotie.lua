...
function x001101_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x001101_g_ScriptId, "Giám ð¸nh tß ch¤t", 6, 1 )
		AddNumText( sceneId, x001101_g_ScriptId, "Cñc hÕn ðøc l±", 6, 2 )--ÏÖÔÚÔö¼ÓÒ»ÖÖ´ò¿×·½Ê½£¬Òò´ËÕâ¸ö±ä³É¶þ¼¶½çÃæ
		AddNumText( sceneId, x001101_g_ScriptId, "Khäm ng÷c cñc hÕn", 6, 3 )
		AddNumText( sceneId, x001101_g_ScriptId, "Trích tr× bäo thÕch cñc hÕn", 6, 4 )
		AddNumText( sceneId, x001101_g_ScriptId, "#GGi¾i thi®u ðøc l² cñc hÕn", 11, 5 )
...
--		DispatchUICommand( sceneId, selfId, 75117 )
	...
	BeginEvent( sceneId )
		AddText( sceneId, "Ch÷n phß½ng pháp ðøc l±" )
		AddNumText( sceneId, x001101_g_ScriptId, "Ðøc l± b¢ng vàng", 6, 10 )
		AddNumText( sceneId, x001101_g_ScriptId, "Dùng Hàn Ng÷c tinh túy", 6, 11 )
	EndEvent(sceneId)
	DispatchEventList(sceneId,selfId,targetId)
