...
function x033031_OnDefaultEvent( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)
		...
		if(strCity0Name ~= "") then AddNumText(sceneId,x033031_g_scriptId,"Thành ph¯ 1  "..strCity0Name,9,0) end
		if(strCity1Name ~= "") then AddNumText(sceneId,x033031_g_scriptId,"Thành ph¯ 2  "..strCity1Name,9,1) end
		if(strCity2Name ~= "") then AddNumText(sceneId,x033031_g_scriptId,"Thành ph¯ 3  "..strCity2Name,9,2) end
		if(strCity3Name ~= "") then AddNumText(sceneId,x033031_g_scriptId,"Thành ph¯ 4  "..strCity3Name,9,3) end
