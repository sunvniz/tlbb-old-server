...
function x008011_UpdateEventList( sceneId, selfId,targetId )
	...
	BeginEvent( sceneId )
		...
		if missionIndex ~= -1 then
			...
			if missionName ~= "Cßu Ma TríÈÎÎñ" and IsMissionHaveDone( sceneId, selfId, x008011_g_ActivateMissionId ) > 0 then
				AddNumText( sceneId, x008011_g_scriptId, "Cßu Ma TríÈÎÎñ", 3, 1 )
			end
...
function x008011_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if num == 1 then										-- Cßu Ma TríÈÎÎñ
		...
		--¿´ÏÂ½ñÌìtoÕ ğµ Cßu Ma TríÈÎÎñĞúng²»Ğúng×öÍê50´ÎÁË
