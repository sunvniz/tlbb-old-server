...
x181003_g_buyact	 	= 2		--¶mµt »Ôª±¦
x181003_g_ticketact = 3		--¶mµt »Ôª±¦Æ±
x181003_g_zdianact	= 4		--Ôù ði¬mÉÌµê
x181003_g_gotodali	= 5		--Tr· v«LÕc Dß½ng

x181003_g_normalzdianshop	= 6		--ÆÕÍ¨Ôö ði¬mÉÌµê
x181003_g_lv1zdianshop	= 7			--mµt c¤p²ÄÁÏ
x181003_g_lv2zdianshop	= 8			--¶þc¤p²ÄÁÏ
x181003_g_lv3zdianshop	= 9			--Èýc¤p²ÄÁÏ
x181003_g_lv4zdianshop	= 10		--ËÄc¤p²ÄÁÏ
x181003_g_lv5zdianshop	= 11		--Îåc¤p²ÄÁÏ
x181003_g_lv6zdianshop	= 12		--Áùc¤p²ÄÁÏ
x181003_g_lv7zdianshop	= 13		--Æßc¤p²ÄÁÏ
x181003_g_lv8zdianshop	= 14		--°Ëc¤p²ÄÁÏ
x181003_g_lv9zdianshop	= 15		--¾Åc¤p²ÄÁÏ
x181003_g_lv10zdianshop	= 16		--Ê®c¤p²ÄÁÏ
x181003_g_newprize	= 17		--²é¿´ÖÐ½±
x181003_g_YuanBaoIntro	= 18	--Ôª±¦½éÉÜ

x181003_g_leave			= 20	--Àë¿ª
x181003_g_return		= 21	--Tr· v«(Ö÷²Ëµ¥)
x181003_g_return1		= 22	--Tr· v«(Ôª±¦ÉÌµê)
...
x181003_g_YBShop		=
{
	...
	[1]	= { name = "Nhi®t mÕi thß½ng nhân", id = 151, key = 101 },
	[2]	= { name = "Ti®m Trân thú Phi Phi", id = 152, key = 102 },
	[3]	= { name = "M­ Lan th¶i trang ðiªm", id = 120, key = 103 },
	[4]	= { name = "Lßu Dß½ng hoa pháo ðiªm", id = 132, key = 104 },
...
x181003_g_YBXingXiangShops =
{
	...
	[4] = { name = "Lan vû mÛ dung phß¶ng", id = 182, key = 117 }	--add by zchw
}

--Ôª±¦±¦Ê¯µê--add by xindefeng
x181003_g_YBBaoshiShops =
{
	[1]	= { name = "Phòng bäo thÕch Tô Châu", id = 150, key = 119 },
	[2]	= { name = "Phòng bäo thÕch LÕc Dß½ng", id = 178, key = 120 },
	[3]	= { name = "#gff00f0Ti®m bäo thÕch tinh hoa", id = 198, key = 132 }   -- added by houzhifang in 20081107 tt:40793; 120--131±»ÓÃ¹ýÁË
}
...
{
	[1]	= { name = "Höa thø ngân hoa", id = 190, key = 300 },
	[2]	= { name = "Tiªt nh§t hï khánh", id = 191, key = 301 },
	[3]	= { name = "Xuân Thành bách hoa", id = 192, key = 302 },
}

--ÌÒ±¤ÆæÎïµê
x181003_g_YBQiWuShops =
{
	[1]	= { name = "Linh lung thÕch ð¥u kí", id = 193, key = 303 },
	[2]	= { name = "D¸ thú gia công phß¶ng", id = 194, key = 304 },
	[3]	= { name = "Nam b¡c kÏ hoà", id = 195, key = 305 },
	[4]	= { name = "Ti®m bäo thÕch", id = 137, key = 306 },
}
...
x181003_g_YBReMaiShops =
{
	...
	[2] = { name = "Nhi®t mÕi thß½ng ph¦m", id = 189, key = 309 },
}
...
--			if targetId >= 0 then
--				AddNumText( sceneId, x181003_g_scriptId, "Ta mu¯n ð±i kim nguyên bäo", 2, x181003_g_buyact)
--				if IsShutout( sceneId, selfId, ONOFF_T_YBCASH ) == 0 then
--					AddNumText( sceneId, x181003_g_scriptId, "Ta mu¯n ð±i phiªu kim nguyên bäo", 2, x181003_g_ticketact)
--				end
--			else
...
--			end
			...
			AddNumText(sceneId,x181003_g_scriptId, "Chuyên bán ðä tÕo ð°", 7, x181003_g_DZYBact)
			AddNumText( sceneId, x181003_g_scriptId, "Gi¾i thi®u thß½ng ti®m Nguyên bäo và Ði¬m t£ng", 11, x181003_g_YuanBaoIntro)
			if targetId < 0 then
				targetId = -1
			end
		EndEvent( sceneId )
...
function x181003_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	elseif GetNumText() == x181003_g_return then
		local nID = targetId;
		if nID < 0 then nID = -2 end -- -2Ðúng²Ëµ¥,-1ÐúngÏìÓ¦
...
--			AddNumText( sceneId, x181003_g_scriptId, "Tr· v«ÉÏmµt Ò³", -1, x181003_g_return)
--		EndEvent( sceneId )
--		DispatchEventList( sceneId, selfId, targetId )
		local nID = targetId;
		if nID < 0 then nID = -2 end -- -2Ðúng²Ëµ¥,-1ÐúngÏìÓ¦
	...
	elseif GetNumText() == x181003_g_DZYBact then
		BeginEvent( sceneId )
			...
			AddNumText( sceneId, x181003_g_scriptId, "Tr· v« trang trß¾c", -1, x181003_g_return1)
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	elseif GetNumText() == x181003_g_zdianact then
		BeginEvent( sceneId )
			...
			AddText( sceneId, strText )
			AddNumText( sceneId, x181003_g_scriptId, "Thß½ng ph¦m ph± thông t£ng ði¬m", 7, x181003_g_normalzdianshop)
	...
	elseif GetNumText() == x181003_g_YuanBaoIntro	then
		...
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	elseif GetNumText() == 102 then	--Thiên LongÕäÊÞµê	--add by xindefeng
		BeginEvent( sceneId )
		...
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	elseif GetNumText() == 104 then	--Thiên LongÐÎÏó¹Ý	--add by xindefeng
		BeginEvent( sceneId )
		...
		EndEvent( sceneId )
		DispatchEventList( sceneId, selfId, targetId )
	elseif GetNumText() == 109 then	--Thiên Long±¦Ê¯µê--add by xindefeng
		BeginEvent( sceneId )
	...
	elseif GetNumText() == 101 then	--ÈÈÂôÉÌµê
		...
		--Thiên LongÕäÊÞµê--add by xindefeng
		for i = 1, getn( x181003_g_YBPetShops ) do
		...
		--Thiên LongÐÎÏó¹Ý--add by xindefeng
		for i = 1, getn( x181003_g_YBXingXiangShops ) do
