...
function x014007_OnDefaultEvent( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		if	GetLevel( sceneId, selfId)>=10  then	
			...
			AddNumText( sceneId, x014007_g_ScriptId, "Tô Châu - Thiªt Tß¶ng Ph¯", 9, 4 )
		end
		
		--add by WTT
		if	GetLevel( sceneId, selfId)>=20  then	
			AddNumText( sceneId, x014007_g_ScriptId, "Thúc hà C±ng Tr¤n", 9, 6 )
		end
		...
		AddNumText(sceneId,x014007_g_ScriptId,"Ðªn ta ðªn nhæng môn phái khác",9,11)
