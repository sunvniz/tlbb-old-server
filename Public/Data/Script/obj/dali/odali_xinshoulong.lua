...
function x002031_UpdateEventList( sceneId, selfId,targetId )
	...
	if curDayTime >= x002031_g_startTime and curDayTime <= x002031_g_EndTime then
		...
		AddText(sceneId,"#{OBJ_dali_0013}"..PlayerName..PlayerSex..", mu¯n thØ thân thü không?")		--#r  TÕi ÏÂ²»²Å,È´Ò²ÓÐ¡°½­ºþ°ÙÏþÉú¡±toÕ ðµ ÐéÃû,¶Ô¹Å½ñÌìÏÂ½­ºþÖ®ÊÂ¶¼ÂÔÖªmµt ¶þ,ÈôÓÐÊ²Ã´ÒÉÎÊ,Äã¿ÉÒÔ¾¡¹ÜÀ´ÕÒÎÒ.--#r  #r#r  ¡°ÄãÎÊÎÒ´ð¡±£­ÎÒÀ´¸æËßÄãmµt Ð©½­ºþÊÂ.  #r#r  ¡°ÎÒÎÊÄã´ð¡±£­Á¬Ðø´ð¶ÔÎÊÌâ¾Í×ÊÖúÄãÒøÁ½.
	end
