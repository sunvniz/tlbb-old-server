...
function x002004_UpdateEventList( sceneId, selfId,targetId )
	...
	BeginEvent(sceneId)	
		...
		if missionIndex ~= -1 then
			...
			if missionName ~= "Nhi®m vø Ðoàn Diên Khánh" and IsMissionHaveDone( sceneId, selfId, x002004_g_ActivateMissionId ) > 0 then
				AddNumText( sceneId, x002004_g_scriptId, "Nhi®m vø Ðoàn Diên Khánh", 3, 1 )
			end
...
function x002004_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if num == 1 then										-- Nhi®m vø Ðoàn Diên Khánh
		...
		--¿´ÏÂ½ñÌìtoÕ ðµ Nhi®m vø Ðoàn Diên KhánhÐúng²»Ðúng×öÍê50´ÎÁË
