...
function x714120_OnDefaultEvent( sceneId, selfId,targetId )
	...
	if AbilityLevel ~= 0	then
		BeginEvent(sceneId)
			...
			--Í¨¹ýx714120_g_eventListºÍscriptglobalÖÐtoÕ ðµ Ö²ÎïÁÐ±í¶Ô±È,²¢¸ù¾ÝÍæ¼ÒÖÖÖ²¼¼ÄÜµÈc¤pÀ´ÏÔÊ¾ÏàÓ¦Ö²Îï
			for i, scriptId in x714120_g_eventList do	--±éÀúCái này µ¾²ÝÈË¿ÉÒÔÖÖÖ²toÕ ðµ Ö²ÎïÁÐ±í
