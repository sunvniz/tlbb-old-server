...
--0.Xây dñng thß½ng ðiªm riêng->ÏÔÊ¾½¨µêÌõ¿î->ÓÉ¿Í»§¶ËÇëÇó½¨µê
		...
		--6.Gi¾i thi®u thß½ng ti®m ngß¶i ch½i
		...
		elseif	GetNumText()==8	then
			...
			elseif canErase == -1 then
				local msg = format("ÄútoÕ ðµ ÉÌµêÒÑ±»¶³½á.");
				BeginEvent( sceneId )
					AddText( sceneId, msg )
				EndEvent( sceneId )
				DispatchMissionTips( sceneId, selfId )
