...
function x002957_UpdateEventList( sceneId, selfId,targetId )
	BeginEvent(sceneId)
		...
		AddNumText( sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»îÖÁ×ğÉñÆ÷ÓÎÔÆ¾ªÁú", 1, 100 )
		AddNumText( sceneId, x002957_g_ScriptId, "Àë¿ª¡­¡­", 13, 0 )
...
function x002957_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if nNumText == 100 then
		BeginEvent(sceneId)
			...
			if nNumText == 100 then
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#Y·ï¸èğ½Îèmµt ¼¶", 1, nNumText+10)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#Y·ï¸èğ½Îè¶ş¼¶", 1, nNumText+20)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#Y·ï¸èğ½ÎèÈı¼¶", 1, nNumText+30)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#Y·ï¸èğ½ÎèËÄ¼¶", 1, nNumText+40)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾¶¾¡¿·ï¸èğ½Îè", 1, nNumText+50)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾±ù¡¿·ï¸èğ½Îè", 1, nNumText+60)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾»ğ¡¿·ï¸èğ½Îè", 1, nNumText+70)
--			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾Ğş¡¿·ï¸èğ½Îè", 1, nNumText+80)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#YÓÎÔÆ¾ªÁúmµt ¼¶", 1, nNumText+90)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#YÓÎÔÆ¾ªÁú¶ş¼¶", 1, nNumText+100)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#YÓÎÔÆ¾ªÁúÈı¼¶", 1, nNumText+110)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#YÓÎÔÆ¾ªÁúËÄ¼¶", 1, nNumText+120)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾¶¾¡¿ÓÎÔÆ¾ªÁú", 1, nNumText+130)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾±ù¡¿ÓÎÔÆ¾ªÁú", 1, nNumText+140)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾»ğ¡¿ÓÎÔÆ¾ªÁú", 1, nNumText+150)
			AddNumText(sceneId, x002957_g_ScriptId, "#gFF6A6A#G¼¤»î#I¡¾Ğş¡¿ÓÎÔÆ¾ªÁú", 1, nNumText+160)
			end																	
			AddNumText( sceneId, x002957_g_ScriptId, "Àë¿ª¡­¡­", 0, 0 )
		EndEvent(sceneId)
		DispatchEventList(sceneId,selfId,targetId)
		return
	end
	...
	if nNumText > 100 and nNumText < 800  then
		BeginEvent(sceneId)
			...
			local szStr = "  Òª ğÕt ğßşcÕâĞ©×°±¸,Ngß½i c¥n ¸øÎÒ#gfff0f0¡°" .. x002957_g_StoneList[nLevel].str
										.. "¡±#cFFCC00¡°".. tostring(x002957_g_StoneList[nLevel].num) .. "¡±#Wcái  #r#cFFCC00 ği¬mÆäÕß ği¬mÌìÏÂ,ÎäÁÖÖĞÈËÃÎÃÂÒÔÇótoÕ ğµ ÉñÆ÷£¡#W"
