...
x000177_g_NeedItemId = 30309825     --TÕi CommonItem.txtÐÂ¼ÓtoÕ ðµ ÏÊ»¨toÕ ðµ ÖÖ×Ó´úÂë

x000177_g_scenePosInfoList = {
	{sceneId=0, sceneName="LÕc Dß½ng", minL=30, maxL=45,  posList={
																						{x=256, z=252, r=10},
		}
	},
}
...
--ÏÂÁÐtoÕ ðµ monsterIDÒÀ´Î¶ÔÓ¦ÓÚtoÕ ðµ µÈ¼¶Îª11, 21, 31, 41, 51, 61, 71, 81, 91, 101...201
...
x000177_g_TitleTableOfMonster = {
		{part2="Gieo tr°ng hÕt gi¯ng"},
						}
						
x000177_g_NameTableOfMonster = {
	{part1="Hoa tiên tØ", part2="Tinh", part3="Linh"},
					}						
...
function x000177_GetSceneIdByPlayerLevel(playerLevel)
	if playerLevel >= 100 then -- ´óÓÚµÈÓÚ100¼¶toÕ ðµ Íæ¼ÒÔòËùÓÐtoÕ ðµ ³¡¾°¶¼ÐúngËæ»útoÕ ðµ 
...
function x000177_CreateTitleAndName_ForCangBaoTu(sceneId, selfId)
	...
	--ÉèÖÃÉú³ÉmonstertoÕ ðµ ³ÆºÅ
	local ct = getn(x000177_g_TitleTableOfMonster)
	local ret = random(ct)
	local part1 = x000177_g_TitleTableOfMonster[ret].part1
	ret = random(ct)
	local part2 = x000177_g_TitleTableOfMonster[ret].part2
       local PlayerName=GetName(sceneId,selfId)	     --È¡ ði¬mÕýTÕi ÖÖÖ²toÕ ðµ Íæ¼ÒTên
	local strTitle = format("%s%s", PlayerName, part2)     --È»ºóÌí¼Óµ½ÕÙ»½³ötoÕ ðµ Ó×Ãç³ÆºÅÀïÃæ

	--ÉèÖÃÉú³ÉmonstertoÕ ðµ name
	ct = getn(x000177_g_NameTableOfMonster)
	ret = random(ct)
	local part1 = x000177_g_NameTableOfMonster[ret].part1
	ret = random(ct)
...
--**********************************
--¸ù¾ÝÍæ¼ÒµÈ¼¶¶ÔÓ¦Éú³ÉmonstertoÕ ðµ ID
--**********************************
