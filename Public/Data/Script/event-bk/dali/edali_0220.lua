...
x210220_g_MissionTarget="    Ðªn #YTrùng Ði¬u phß¶ng#W · #Gðß¶ng l¾n phía Ðông cüa thành ÐÕi Lý#W tìm phß¶ng chü #RVân Phiêu Phiêu #W#{_INFOAIM265,129,2, Vân Phiêu Phiêu}. "
...
function x210220_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø: Làm sao b¡t trân thú",MSG2PLAYER_PARA )
...
function x210220_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	if x210220_CheckSubmit( sceneId, selfId, selectRadioId ) == 1 then
		...
		Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø#W: Làm sao b¡t trân thú",MSG2PLAYER_PARA )
