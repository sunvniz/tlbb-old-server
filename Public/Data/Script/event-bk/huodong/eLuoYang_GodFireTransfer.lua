...
--LÕc Dß½ngNhi®m vø Rùa-Thö thi chÕyÊÂ¼ş½Å±¾
...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x808080_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
...
x808080_g_Custom	= { {id="Ğã cùng LÕc Dß½ng Tri®u Minh Thành ğ¯i thoÕi",num=1}, {id="Ğã cùng Tô Châu Løc Sî Tranh ğ¯i thoÕi",num=1}, {id="Ğã cùng ĞÕi Lı Vß½ng Nhßşc Vû ğ¯i thoÕi",num=1}, {id="Ğã châm toàn bµ ğèn Kh±ng Minh",num=24} }
--MisDescEnd

--ÈÎÎñĞúng·ñÍê³É
x808080_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--»ğ°ÑLÕc Dß½ng´ò¿¨±ê¼Ç
x808080_g_RecordIdx 				 = 1		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ1Î» 1.LÕc Dß½ng 2.Tô Châu 3.ĞÕi Lı
--¿×Ã÷µÆÍê³ÉÊıÁ¿±ê¼Ç
x808080_g_KongMing_Lighten	 = 4		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ4Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x808080_g_MissScriptID_Idx	 = 5		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ5Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x808080_g_AcceptNPC_Idx			 = 6		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ6Î» 1.LÕc Dß½ngNPC 2.Tô ChâuNPC 3.ĞÕi LıNPC
--Nhi®m vø Rùa-Thö thi chÕyÃ¿ÌìÂÖÊı±ê¼Ç
x808080_g_RoundIndex 				 = 7		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ7Î»


x808080_g_AcceptMission_IDX		= 520	--Rùa-Thö thi chÕy½ÓÊÕÈÎÎñË÷Òı
x808080_g_CompleteMission_IDX	= 521	--»ğ°ÑÌá½»ÈÎÎñË÷Òı
x808080_g_MissionInfo_IDX			= 522	--ÈÎÎñË ği¬m÷Ë÷Òı

x808080_g_Jion_Count = 0						--±¨ÃûÈËÊı±ê¼Ç
x808080_g_Join_CountMax = 50				--±¨ÃûÈËÊıÉÏÏŞ

x808080_g_KongMingLighten_MaxCnt	=	24	-- Rùa-Thö thi chÕy»î¶¯C¥n  ği¬mÈ¼toÕ ğµ ¿×Ã÷µÆ×ÜÊı

--ËùÓµÓĞtoÕ ğµ ÊÂ¼şIDÁĞ±í
x808080_g_EventList	= {}

x808080_g_Impact_Accept_Mission 	= 47	-- Tiªp thøÈÎÎñÊ±toÕ ğµ ÌØĞ§ID
x808080_g_Impact_Light_Complete 	= 38	--  ği¬mÁÁ¿×Ã÷µÆÊ±toÕ ğµ ÌØĞ§
x808080_g_Impact_Transport_Mission = 113 -- ÔËÊä×´Ì¬ÌØĞ§
x808080_g_Impact_GodOfFire_Mission = 5929 -- Rùa-Thö thi chÕy×´Ì¬ÌØĞ§
x808080_g_PlayerSlow_LVL					= 20	-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x808080_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if LuaFnGetName( sceneId, targetId ) ~= x808080_g_Name then
		x808080_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
		return 0
	end
...
function x808080_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x808080_g_ScriptId, "Ta mu¯n tham gia Rùa-Thö thi chÕy", 7, x808080_g_AcceptMission_IDX )
	AddNumText( sceneId, x808080_g_ScriptId, "Ta ğã mu¯n hoàn thành Rùa-Thö thi chÕy", 7, x808080_g_CompleteMission_IDX )
	AddNumText( sceneId, x808080_g_ScriptId, "V« hoÕt ğµng Rùa-Thö thi chÕy", 11, x808080_g_MissionInfo_IDX )
...
function x808080_OnAbandon( sceneId, selfId )
  ...
  if HaveItem(sceneId, selfId, x808080_g_ItemId.id) > 0 then
  	if LuaFnGetAvailableItemCount(sceneId, selfId, x808080_g_ItemId.id) >= x808080_g_ItemId.num then
	  	...
	  	x808080_NotifyTip( sceneId, selfId, "V§t ph¦m cüa các hÕ hi®n không dùng ğßşc ho£c ğã b¸ khóa." )			
			return 0
  	end
  end
...
function x808080_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	--ÅĞ¶Ï¸ÃnpcĞúng·ñĞúng¶ÔÓ¦ÈÎÎñtoÕ ğµ npc
	if LuaFnGetName( sceneId, targetId ) ~= x808080_g_Name then
		x808080_NotifyTip( sceneId, selfId, "Trä nhi®m vø th¤t bÕi" )					
		return 0
	end
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x808080_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
end
