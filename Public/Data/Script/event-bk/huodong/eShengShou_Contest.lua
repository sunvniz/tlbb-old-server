...
function x808066_GiveSkillBook( sceneId, selfId, activatorId )
	...
	if BagIndex ~= -1 then
		...
		local str = format( "#W#{_INFOUSR%s}#P TÕi #GThánh Thú S½n#P cØ yên phóng höa không c¦n th§n ánh m¡t, m½ h° bên trong ðánh vào #YÐÕi bäo sß½ng #P, m· ra v×a th¤y, dî nhiên là mµt quy¬n #{_INFOMSG%s}.", PlayerName, ItemTransfer )
