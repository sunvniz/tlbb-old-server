---------------------------------------------------
--Name: 	2008 5.1»î¶¯½Å±¾ Ö® Ç©ÃûÅÆ¶mµt »
--Author: 	Áõ¶Ü
--Date: 	2008-04-15
---------------------------------------------------
...
--	PetCagePresentStartTime 		= 20080415, --¶mµt »ÊŞÀ¸¿ªÊ¼Ê±¼ä
--	PetCagePresentEndTime 			= 20080417, --¶mµt »ÊŞÀ¸½áÊøÊ±¼ä
...
function x808091_OnDefaultEvent( sceneId, selfId, targetId )
	...
	elseif(ItemID == 808091003) then
		...
		--·¢·Å¶mµt »Ç©ÃûÅÆ,²¢¸ømµt cái50 phúttoÕ ğµ buf
		if condition == 0 then
		...
		--ÒÑ¾­²Î¼Ó¹ı¶mµt »Ç©ÃûÅÆtoÕ ğµ »î¶¯ÁË, ²¢ÇÒÒÑ¾­¶mµt »ÁËÊŞÀ¸
...
function x808091_PresentPetCageCard(sceneId, selfId, targetId)
	...
	if (present_card_condition == 0) then
		...
		--Ìí¼Ó50 phúttoÕ ğµ ÌØĞ§
		x808091_PresentPetCageBuffer(sceneId, selfId)
		return 1
	
	--ÈÎÎñÎïÆ·Ch² tr¯ng trong túi xách không ğü
