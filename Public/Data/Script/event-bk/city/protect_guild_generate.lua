...
function x805041_OnTimer( sceneId, actId, uTime )
	...
	then
		...
		AddGlobalCountNews( sceneId, "@*;SrvMsg;SCA:#P"..cityDefaultName.."Báo ðµng! Thành th¸ Bang hµi "..cityName.." Bên trong ðµt nhiên xu¤t hi®n mµt ðám s½n th¥n s½n quÖ, thïnh các v¸ huynh ð® l§p tÑc tr· v« bang hµi quét sÕch kë ð¸ch." )
