...
-- abilityId: Éú»î¼¼ÄÜºÅ
-- aMaxLevel: ¸ÃÏîÉú»î¼¼ÄÜtoÕ ðµ ×î´óc¤p±ð
-- aLevelLimit: ¶Ô¸ÃÅä·½²úÉúÓ°ÏìtoÕ ðµ Éú»î¼¼ÄÜµÈc¤pÉÏÏÞ
-- recipeLevel: Åä·½µÈc¤p
-- vigorCost: ¸ÃÏîÅä·½toÕ ðµ »îÁ¦ÏûºÄ(ÓÉÓÚÐÂÉè¼Æ,Õâmµt ÌõÔÝÊ±×÷·Ï)
-- energyCost: ¸ÃÏîÅä·½toÕ ðµ TinhÁ¦ÏûºÄ
-- matClassBase: ¸ÃÅä·½Ê¹ÓÃtoÕ ðµ ²ÄÁÏ×é»ùÊý[²ÄÁÏ×é±ØÐë°´µÈc¤pÁ¬Ðø]
-- matClassCount: ¸ÃÅä·½Ê¹ÓÃtoÕ ðµ ²ÄÁÏ×éÊý
-- matCostBase: ¸ÃÏîÅä·½toÕ ðµ ²ÄÁÏÏûºÄ»ùÊý
-- matFactor: ²ÄÁÏÏûºÄ±¶³ËÒò×Ó
-- succProductClass: ºÏ³É³É¹¦toÕ ðµ ²úÆ·×é
-- failProductClass: ºÏ³Éth¤t bÕitoÕ ðµ ²úÆ·×é,¸ù¾ÝÍæ¼ÒtoÕ ðµ Éú»îc¤p±ð¸ø³öÏàÓ¦toÕ ðµ th¤t bÕi²úÆ·×éÒÔ¼°³öÏÖ¼¸ÂÊ
--		defaultClass: Í¨³£²»»áÓÃµ½,Ö»ÓÐµ±Ë÷Òý³ö´íÊ±»áÓÃµ½
--		[n]: ±íÊ¾µ±Íæ¼ÒtoÕ ðµ Éú»î¼¼ÄÜ¶ÔÓ¦Îª n c¤pÊ±²ÉÓÃ
--			prodClass, odds: µ±¼¸ÂÊ·ûºÏ¸ÃÌõ¼þ random(x700900_g_RandNum) < odds Ê± prodClass ¶ÔÓ¦toÕ ðµ ²úÆ·×é±»Ê¹ÓÃ
...
-- ÐÞ¸Ä: »îÁ¦ÏûºÄ°´ÕÕÒÔÏÂÐÂÉè¶¨À´Ö´ÐÐ
...
----------------------------------------------------------------------------------------
-- ²ÄÁÏ¼ì²éº¯Êý,ÅÐ¶ÏÍæ¼ÒÉíÉÏÐúng·ñÓÐ×ã¹» quantity toÕ ðµ  class Àà²ÄÁÏ
-- class: ²ÄÁÏtoÕ ðµ ÖÖÀà
-- quantity: ²ÄÁÏËùÐètoÕ ðµ ÊýÁ¿
-- Èç¹û·ûºÏÌõ¼þ,ÔòTr· v« 1,·ñÔòTr· v« 0
----------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------
-- ÏûºÄ²ÄÁÏ,ÏûºÄÍæ¼Ò quantity ÊýÁ¿toÕ ðµ  class Àà²ÄÁÏ
-- ±¾º¯Êý²»±£Ö¤²ÄÁÏ×ã¹»,ÓÉµ÷ÓÃº¯ÊýÀ´±£Ö¤
-- class: ²ÄÁÏtoÕ ðµ ÖÖÀà
-- quantity: ²ÄÁÏËùÐètoÕ ðµ ÊýÁ¿
-- ³É¹¦Tr· v« 1,th¤t bÕiTr· v« 0
----------------------------------------------------------------------------------------
...
function x700900_CheckForResult( sceneId, selfId, AbilityID, RecipeLevel, MatLevel )
	...
	-- ¸ÅÂÊ
	-- ³É¹¦ÂÊ£½10£¥£«ÏûºÄ²ÄÁÏµÈc¤p¡Á0.5£¥£«¸¨Öú¼¼ÄÜµÈc¤p¡Á0.2£¥
	-- local odds = 10 + MatLevel / 2 + AssisAbilityLevel / 5
	--	ÐÂtoÕ ðµ ³É¹¦ÂÊ£½5£¥£«ÏûºÄ²ÄÁÏµÈc¤p¡Á0.25£¥£«¸¨Öú¼¼ÄÜµÈc¤p¡Á0.1£¥
...
----------------------------------------------------------------------------------------
-- Éú³ÉºÏ³ÉÎï
-- class: ºÏ³ÉÎïtoÕ ðµ ÖÖÀà
-- ³É¹¦Tr· v« ÎïÆ· ID,th¤t bÕiTr· v« -1
----------------------------------------------------------------------------------------
function x700900_ProduceComplex( sceneId, selfId, class, RecipeLevel, AbilityLevel, AbilityMaxLevel )
	...
	-- Ëæ»ú³ömµt cáiÊý [1, x700900_g_RandNum]
...
function x700900_AbilityProduce( sceneId, selfId, recipeId )
	...
	if bCanGainExp == 1 then						--  ðÕt ðßþcÊìÁ·¶È
