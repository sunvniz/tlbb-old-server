...
function x212142_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if GetTeamSize(sceneId,selfId) < x212142_g_LimitMembers  then
		BeginEvent(sceneId)
			AddText(sceneId,"  Mu¯n tiªn vào bän sao này, các hÕ c¥n mµt nhóm có ít nh¤t "..x212142_g_LimitMembers.." ngß¶i, h½n næa thành viên trong nhóm c¥n có t±ng cµng ít nh¤t "..x212142_g_LimitMembers.." ngß¶i · g¥n, các hÕ còn c¥n là nhóm trß·ng.");
		EndEvent(sceneId)
