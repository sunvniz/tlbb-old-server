...
function x895065_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format(" #{_INFOUSR%s}#P không chªt cûng u±ng!", playerName); --É£ÍÁ¹«
		AddGlobalCountNews( sceneId, str )
	end

	CallScriptFunction( x895065_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  võ lâm suy tàn anh hùng hµi!" )
...
function x895065_UseSkillF( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Tiêu Nhß Quân", "Binh thánh kÏ tr§n", "Tiêu Nhß Quân: "..GetName( sceneId, PlayerId ).." trình ngß½i quá kém!" )
	CallScriptFunction( x895065_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân nói chu¦n quá!" )
...
function x895065_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x895065_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Thi phóng ðích thÑ trúc hãm t¸nh sinh vu túc hÕ, hoàn thïnh chß v¸ t¯c t¯c ðóa t¸." )
...
function x895065_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x895065_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Phát ðµng hßu dßÞng sinh tÑc chi thu§t. Thø ð°ng tâm trúc tß½ng trþ, huynh ð® nh¸ nhân giai dî mi­n d¸ch thß½ng hÕi. Nhßþc nång phá trúc, t¡c ð¯i Ñng phòng ngñ khä b¸ mi­n tr×." )
