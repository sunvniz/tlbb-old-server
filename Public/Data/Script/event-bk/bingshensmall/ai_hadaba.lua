...
function x895064_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format(" #GTiêu D§t Phong#W và #{_INFOUSR%s}#W häo kªt kim lan", playerName); --¹ş´ó°Ô
...
function x895064_UseSkillB( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Tiêu D§t Phong", "Binh thánh kÏ tr§n", "Tiêu D§t Phong: Làm Long Vån nhß thª nào v§y!" )
	CallScriptFunction( x895064_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: Ai biªt chï h¡n kìa!" )
...
function x895064_UseSkillC( sceneId, selfId )
	...
	CallScriptFunction( x895064_g_FuBenScriptId, "CreateBOSS", sceneId, "FengLei_BOSS", x, z )
	CallScriptFunction( x895064_g_FuBenScriptId, "CreateBOSS", sceneId, "FengLei_BOSS", x, z )
	CallScriptFunction((200060), "Paopao",sceneId, "Tiêu D§t Phong", "Binh thánh kÏ tr§n", "Tiêu D§t Phong: #c2ebeff"..GetName( sceneId, PlayerId ).." #W ai viªt ra Thiên Long Bát Bµ thª?" )
	CallScriptFunction( x895064_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: #c2ebeff"..GetName( sceneId, PlayerId ).." nói cho h¡n biªt ği!" )
...
function x895064_UseSkillD( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Tiêu D§t Phong", "Binh thánh kÏ tr§n", "Tiêu D§t Phong: #c2ebeff"..GetName( sceneId, PlayerIdA )..","..GetName( sceneId, PlayerIdB ).."#W sån Boss cùng ta không?" )
	CallScriptFunction( x895064_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Uh" )
