...
function x895096_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x895096_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Thi phóng ğích thÑ trúc hãm t¸nh sinh vu túc hÕ, hoàn thïnh chß v¸ t¯c t¯c ğóa t¸." )
...
function x895096_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x895096_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Phát ğµng hßu dßŞng sinh tÑc chi thu§t. Thø ğ°ng tâm trúc tß½ng trş, huynh ğ® nh¸ nhân giai dî mi­n d¸ch thß½ng hÕi. Nhßşc nång phá trúc, t¡c ğ¯i Ñng phòng ngñ khä b¸ mi­n tr×." )
...
function x895096_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if impactId == 19413 then
		...
		CallScriptFunction( x895096_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Huynh ğ® ğ°ng tâm, kì lñc ğoÕn kim. . . . . . Do vu v¸ tÕi 30 mi¬u nµi toàn di®t tiêu th¸ ğ® huynh, tiêu nhß úy hi®n dî phøc sinh. . . . . . ." )
