...
--	x806015_MessageBox( sceneId, selfId, targetId, msg )
	...
	local	str	= format( "#IXin chúc m×ng#W#{_INFOUSR%s}#Ithành công ðÕt ðßþc #G%s#I danh xßng, có th¬ thu nh§n nhæng ngß¶i ch½i khác làm ð° ð®.", nam, x806015_g_Title[level] )
