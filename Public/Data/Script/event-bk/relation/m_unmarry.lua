...
function x806005_CheckAccept( sceneId, selfId, targetId )
	--(1) ði¬m»÷Õß×é¶Ó,²¢ÇÒ¶ÓÎéÖ»ÓÐ2cáiÈË
	...
	--(2)¶ÓÎéÖÐÐúng·ñAÐúngBtoÕ ðµ ·ò¾ý,BÐúngAtoÕ ðµ ÆÞ×Ó
	...
	--(3)ÄÐ·½ÉíÉÏÐ¯´ø½ðÇ®Ðúng·ñ´óÓÚµÈÓÚN=55555
	--hzp 2008-12-10
...
function x806005_OnSubmit( sceneId, selfId, targetId, tId )
	...
	BeginEvent( sceneId )
		AddText( sceneId, "  Ngß½i có ð°ng ý v¾i "..selfName.." Ly hôn không? Sau khi ly d¸, ðµ häo hæu cüa c£p vþ ch°ng s¨ ðßþc giäm xu¯ng 10, các kÛ nång phu thê ð«u s¨ b¸ xóa.#rLßu ý, ngß¶i ch°ng phäi chi ra #{_EXCHG55555}" )
		AddNumText( sceneId, x806005_g_ScriptId, "Có", 6, 1 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨toÕ ðµ Í¼±ê (Ñ¡ÏîÍ¼±êÎªÊý×ÖÏî)
		AddNumText( sceneId, x806005_g_ScriptId, "Không", 8, 2 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨toÕ ðµ Í¼±ê (Ñ¡ÏîÍ¼±êÎªÊý×ÖÏî)
	EndEvent( sceneId )
...
function x806005_OnAccept( sceneId, male, female )
	...
	--(2)°ÑË«·½toÕ ðµ ºÃÓÑ¶È¶¼ÉèÖÃ³ÉN=X(10),XÎªÄÜ¹»¿´µ½¶Ô·½TÕi ÏßtoÕ ðµ ×îµÍÖµ
