...
function x806004_CheckAccept( sceneId, selfId, targetId )
	...
	--(2)Àë»étoÕ ğµ ÈËÉíÉÏĞ¯´ø½ğÇ®´óÓÚµÈÓÚN=200000
...
function x806004_OnSubmit( sceneId, selfId, targetId )
	BeginEvent( sceneId )
		...
		AddNumText( sceneId, x806004_g_ScriptId, "Có", 6, 1 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨toÕ ğµ Í¼±ê (Ñ¡ÏîÍ¼±êÎªÊı×ÖÏî)
		AddNumText( sceneId, x806004_g_ScriptId, "Không", 8, 2 )		-- 9 + i ÖÆ¶¨¿Í»§¶ËÌØ¶¨toÕ ğµ Í¼±ê (Ñ¡ÏîÍ¼±êÎªÊı×ÖÏî)
	EndEvent( sceneId )
...
function x806004_OnAccept( sceneId, selfId )
	...
	--LuaFnSendNormalMail( sceneId, selfId, SpouseName, selfName .. "ÒÑÑ¡ÔñÁËÓëÄãCßŞng bÑc ly hônÁË,°¦,ËæÔµ°É.ÓÉÓÚ»éÒöÆÆÁÑ,Ä giâyùÑ§·òÆŞ¼¼ÄÜÒÑÈ«²¿Çå¿Õ." )
	
	--É¾³ı¶ÔÓ¦½á»éÊ±toÕ ğµ ÈÎÎñ
