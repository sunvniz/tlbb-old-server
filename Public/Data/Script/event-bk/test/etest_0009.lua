...
local  PlayerName=""
--ÈÎÎñÃû
x804009_g_missionName="×ÏÌ´Ä¾"
x804009_g_missionText_0="×ÏÌ´Ä¾,¿ÉÒ©ÓÃtoÕ ğµ ×ÏÌ´Ä¾"
x804009_g_missionText_1="¾òµØÈı³ß"

x804009_g_missionText_2="ÄãĞúngË­?µ½ÎÒ¹ÈÀï¸ÉÊ²Ã´?"
...
function x804009_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if( IsHaveMission(sceneId,selfId,x804009_g_MissionId) > 0)  then
		if x804009_CheckSubmit(sceneId,selfId) == 1 then
			...
			BeginEvent(sceneId)
			AddText(sceneId,x804009_g_missionName)
			AddText(sceneId,"Ã»ÓĞÈÎÎñµÀ¾ß20001003")
			EndEvent( )
