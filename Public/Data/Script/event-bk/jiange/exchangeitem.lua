...
function x212221_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if stone.num > selfStoneCount   then
		BeginEvent(sceneId)
			strText = format("Xin thÑ l²i, T¥n Hoàng Châu c¥n phäi có %s viên", tostring(stone.num))
  ...
  message = format("#W#{_INFOUSR%s}#P không ngÕi gian khó, ðem ðªn ch²#Y Doanh Vô Danh#P t¤t cä#G T¥n Hoàng Châu#P g°m %s viên, ð±i l¤y #Y#{_INFOMSG%s}#P.",
