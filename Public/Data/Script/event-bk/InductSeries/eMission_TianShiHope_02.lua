...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x500602_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»

--ÈÎÎñÎÄ±¾ÃèÊö
x500602_g_MissionName			= "Thiên sß kì ğãi [2]"
--ÈÎÎñÃèÊö
...
x500602_g_Custom	= { {id="Ğã thång lên c¤p 30",num=1} }
--MisDescEnd

--ÈÎÎñĞúng·ñÍê³É
x500602_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--Ğúng·ñ´ïµ½µÈc¤ptoÕ ğµ ±ê¼Ç
x500602_g_RecordIdx 				 = 1		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ1Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x500602_g_MissScriptID_Idx	 = 2		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ2Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x500602_g_AcceptNPC_Idx			 = 3		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ3Î» 1.LÕc Dß½ngNPC
...
x500602_g_PlayerSlow_LVL					 = 28		-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x500602_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x500602_g_AcceptMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500602_g_Name then
			x500602_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- ÈÎÎñĞúng·ñÒÑÂú
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x500602_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
end
