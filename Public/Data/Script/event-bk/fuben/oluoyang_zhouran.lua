...
x000154_g_ExchGoodsName={"『高级合成』","『兑换小喇叭』","『兑换8级棉布』","『兑换8级密银』"}
x000154_g_ConsumeHonour={1500,50,500,300,150,150,2500}
x000154_g_ExchGoodsIndex={30900016,30505817,20501008,20502008}

x000154_g_MenpaiName={"『兑换1W赠点』","『雕纹金蚕丝』","『兑换6级棉布』","『兑换6级秘银』"}
x000154_g_MenpaiWantHonour = {1000,100,200,200,600,600,600,600} --门派时装需要的荣誉
x000154_g_MenpaiGoodsIndex={20501006,20501006,20501006,20502006,20501006,20501006,20501006,20501006}

x000154_g_WantHonour = 100 --需要的荣誉
x000154_g_GiveBanggong = 50 --给的帮贡

x000154_g_BuyLuoyangMoney = 30000000 --3000金
...
function x000154_UpdateEventList( sceneId, selfId, targetId )
	...
	BeginEvent(sceneId)
		AddText(sceneId,"#G帮战赢取积分，可兑换超级物品，还可购买洛阳城市，物超所值.帮战积分.可用于购买最新高资质全属性5000+宝宝.此BB游戏为非卖非刷品.可兑换小喇叭.92神器和神兵符等！")
...
function x000154_OnEventRequest( sceneId, selfId, targetId, eventId )
	...
	if key == 10 then
		BeginEvent( sceneId )
			AddText( sceneId, "兑换超级物品！" )
			--AddNumText(sceneId, x000154_g_scriptId, "兑换1W赠点票", 6, 100);
			--AddNumText(sceneId, x000154_g_scriptId, "兑换雕纹金蚕丝", 6, 200);
			--AddNumText(sceneId, x000154_g_scriptId, "兑换6级棉布", 6, 300);
			--AddNumText(sceneId, x000154_g_scriptId, "兑换6级秘银", 6, 400);
			--AddNumText(sceneId, x000154_g_scriptId, "我要兑换物品", 6, 500);
