...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x250001_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»

x250001_g_PetDataID=3000	--ÈÎÎñÕäÊŞtoÕ ğµ ±àºÅ
--ÒÔÉÏĞúng¶¯Ì¬**************************************************************
...
x250001_g_MissionTarget="Bang Vân Hán Nhi tìm ğßşc 1 con Sài Miêu. "		--Møc tiêu nhi®m vø
x250001_g_ContinueInfo="Các hÕ b¡t ğßşc Sài Miêu chßa?"		--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x250001_g_MissionComplete="Làm t¯t l¡m. "					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x250001_OnDefaultEvent( sceneId, selfId, targetId )	-- ği¬m»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
	--Èç¹ûÒÑ½Ó´ËÈÎÎñ
...
function x250001_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250001_GetTimePass( sceneId, selfId ) ) then      
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x250001_g_MissionId)			-- ği¬mµ½ÈÎÎñtoÕ ğµ ĞòÁĞºÅ
	...
	SetMissionByIndex(sceneId,selfId,misIndex,1,x250001_g_ScriptId)						--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿toÕ ğµ µÚ1Î»ÖÃÎªÈÎÎñ½Å±¾ºÅ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x250001_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
