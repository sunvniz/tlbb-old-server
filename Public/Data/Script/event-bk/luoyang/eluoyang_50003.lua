...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x250003_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»

x250003_g_PetDataID=3020	--ÈÎÎñÕäÊŞtoÕ ğµ ±àºÅ
--ÒÔÉÏĞúng¶¯Ì¬**************************************************************
...
x250003_g_MissionTarget="Bang Vân Hán Nhi tìm ğßşc 1 con Kê. "		--Møc tiêu nhi®m vø
x250003_g_ContinueInfo="Các hÕ b¡t ğßşc Kê chßa?"		--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x250003_g_MissionComplete="Làm t¯t l¡m. "					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x250003_OnDefaultEvent( sceneId, selfId, targetId )	-- ği¬m»÷¸ÃÈÎÎñºóÖ´ĞĞ´Ë½Å±¾
	--Èç¹ûÒÑ½Ó´ËÈÎÎñ
...
function x250003_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250003_GetTimePass( sceneId, selfId ) ) then      
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x250003_g_MissionId)			-- ği¬mµ½ÈÎÎñtoÕ ğµ ĞòÁĞºÅ
	SetMissionByIndex(sceneId,selfId,misIndex,0,0)						--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿toÕ ğµ µÚ0Î»ÖÃ0 (ÈÎÎñÍê³ÉÇé¿ö)
	SetMissionByIndex(sceneId,selfId,misIndex,1,x250003_g_ScriptId)						--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿toÕ ğµ µÚ1Î»ÖÃÎªÈÎÎñ½Å±¾ºÅ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x250003_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
