...
--»ŒŒÒœﬁ ±
x250037_g_MissionLimitTime = 60 * 60 * 1000; --∫¡ gi‚y

--œ¬√Êº∏œÓ–˙ng∂ØÃ¨œ‘ æto’ µ ƒ⁄»›,”√”⁄T’i »ŒŒÒ¡–±Ì÷–∂ØÃ¨œ‘ æ»ŒŒÒ«Èøˆ**********************
...
x250037_g_MissionTarget="    ó L’c DﬂΩng tÏm H÷ Lai L’c #{_INFOAIM177,94,0, H÷ Lai L’c} s°p x™p b·i thiÍn ∏a.";		--M¯c tiÍu nhiÆm v¯
...
x250037_g_eventId_begin = 0;	-- i¨mª˜∞›ÃÏµÿ»ŒŒÒto’ µ  ¬º˛
x250037_g_eventId_start = 1;	-- i¨mª˜ø™ º∞›ÃÏµÿto’ µ  ¬º˛
x250037_g_eventId_close = 2;	-- i¨mª˜µ»ª·‘Ÿø™ ºto’ µ  ¬º˛


--**********************************
--»ŒŒÒ»Îø⁄∫Ø ˝
--**********************************
function x250037_OnDefaultEvent(sceneId, selfId, targetId)	-- i¨mª˜∏√»ŒŒÒ∫Û÷¥––¥ÀΩ≈±æ
...
function x250037_OnAccept(sceneId, selfId, marryLevel)
	...
	misIndex = GetMissionIndexByID(sceneId, selfId, x250037_g_MissionId);			-- i¨mµΩ»ŒŒÒto’ µ –Ú¡–∫≈
	if misIndex and misIndex >= 0 then
		StartMissionTimer(sceneId,selfId, x250037_g_MissionId);
		SetMissionByIndex(sceneId,selfId,misIndex, 0, 1);						--∏˘æ›–Ú¡–∫≈∞—»ŒŒÒ±‰¡øto’ µ µ⁄0Œª÷√0 (»ŒŒÒÕÍ≥…«Èøˆ)
