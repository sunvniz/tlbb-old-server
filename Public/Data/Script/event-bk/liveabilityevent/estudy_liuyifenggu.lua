...
--Ñ§Ï°½çÃæÒªËµtoÕ ðµ »°
x713537_g_MessageStudy = "Chï c¥n các hÕ ch¸u bö #{_MONEY%d} m¾i có th¬ h÷c ðßþc kÛ nång løc ngh® phong c¯t. Các hÕ có quyªt ð¸nh h÷c không?"
...
function x713537_OnDefaultEvent( sceneId, selfId, targetId, ButtomNum,g_Npc_ScriptId )
	...
	--ÅÐ¶ÏÐúng·ñÒÑ¾­Ñ§»áÁËÁùÒÕ·ç¹Ç,Èç¹ûÑ§»áÁË,ÔòÌáÊ¾ÒÑ¾­Ñ§»áÁË
