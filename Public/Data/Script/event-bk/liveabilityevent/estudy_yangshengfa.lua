...
--Ñ§Ï°½çÃæÒªËµtoÕ ðµ »°
x713528_g_MessageStudy = "Chï c¥n các hÕ ch¸u bö #{_MONEY%d} m¾i có th¬ h÷c ðßþc kÛ nång dßÞng sinh pháp. Các hÕ có quyªt ð¸nh h÷c không?"
...
function x713528_OnDefaultEvent( sceneId, selfId, targetId, ButtomNum,g_Npc_ScriptId,bid )
	...
	--ÅÐ¶ÏÐúng·ñÒÑ¾­Ñ§»áÁËÑøÉú·¨,Èç¹ûÑ§»áÁË,ÔòÌáÊ¾ÒÑ¾­Ñ§»áÁË
...
function x713528_StudyInCity(sceneId, selfId, targetId, ButtomNum,g_Npc_ScriptId,bid)
	if bid then
		if 0 == ButtomNum then
			...
			local studyMsg = format("Nªu các hÕ ðÕt t¾i c¤p %d, phäi tiêu t¯n #{_MONEY%d} và %d ði¬m bang hµi s¨ có th¬ h÷c ðßþc "..x713528_g_AbilityName.." KÛ nång. Ngß½i quyªt ð¸nh h÷c cái gì?", lv, money, con)
