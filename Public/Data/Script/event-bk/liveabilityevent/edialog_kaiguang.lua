...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x713611_OnDefaultEvent( sceneId, selfId, targetId, MessageNum )	--MessageNumĞúng¶Ô»°±àºÅ,ÓÃÓÚµ÷ÓÃ²»Í¬¶Ô»°
		BeginEvent(sceneId)
...
function x713611_OnEnumerate( sceneId, selfId, targetId )
		AddNumText(sceneId,x713611_g_ScriptId,"TÕi hÕ mu¯n tìm hi¬u tr°ng tr÷t",11,-1)
end
