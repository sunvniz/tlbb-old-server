...
x713619_g_button = {"Ğßşc r°i, ğßşc r°i, nói gì thñc tª ği",
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x713619_OnDefaultEvent( sceneId, selfId, targetId, MessageNum )	--MessageNumĞúng¶Ô»°±àºÅ,ÓÃÓÚµ÷ÓÃ²»Í¬¶Ô»°
		BeginEvent(sceneId)
...
function x713619_OnEnumerate( sceneId, selfId, targetId )
		AddNumText(sceneId,x713619_g_ScriptId,"TÕi hÕ mu¯n tìm hi¬u tr°ng tr÷t",11,-1)
end
