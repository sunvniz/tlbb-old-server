...
function x894067_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#cff99cc#{_INFOUSR%s}#cff99cc hÕ thü #GTiêu Nhß Quân#cff99cc hoan hï tè té te!", playerName); --É£ÍÁ¹«
		AddGlobalCountNews( sceneId, str )
	end

	CallScriptFunction( x894067_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Úy và Tiêu Nhß Quân quá ðu¯i!" )
...
function x894067_UseSkillF( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Tiêu Nhß Úy", "Binh thánh kÏ tr§n", "Tiêu Nhß Úy:  "..GetName( sceneId, PlayerId ).." t¾i gi¶ chªt r°i!" )
	CallScriptFunction( x894067_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Úy chém gió ð¤y, ð×ng nghe!" )
...
function x894067_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x894067_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Úy Thi phóng ðích thÑ trúc hãm t¸nh sinh vu túc hÕ, hoàn thïnh chß v¸ t¯c t¯c ðóa t¸." )
...
function x894067_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x894067_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Úy Phát ðµng hßu dßÞng sinh tÑc chi thu§t. Thø ð°ng tâm trúc tß½ng trþ, huynh ð® nh¸ nhân giai dî mi­n d¸ch thß½ng hÕi. Nhßþc nång phá trúc, t¡c ð¯i Ñng phòng ngñ khä b¸ mi­n tr×." )
