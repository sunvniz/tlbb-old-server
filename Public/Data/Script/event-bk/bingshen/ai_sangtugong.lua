...
function x894065_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#{_INFOUSR%s} ðánh bÕi #GTiêu Nhß Quân #cff99cc dành l¤y XXX!", playerName); --É£ÍÁ¹«
		AddGlobalCountNews( sceneId, str )
	end

	CallScriptFunction( x894065_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân và Tiêu Nhß Úy ·ñÔò Tiêu Nhß Quân 30s thông !" )
...
function x894065_UseSkillF( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Tiêu Nhß Quân", "Binh thánh kÏ tr§n", "Tiêu Nhß Quân: ði chªt ði "..GetName( sceneId, PlayerId ).." #3" )
	CallScriptFunction( x894065_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân còn chßa cai sæa!" )
