...
function x894097_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x894097_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Thi phóng ðích thÑ trúc hãm t¸nh sinh vu túc hÕ, hoàn thïnh chß v¸ t¯c t¯c ðóa t¸." )
...
function x894097_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x894097_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Phát ðµng hßu dßÞng sinh tÑc chi thu§t. Thø ð°ng tâm trúc tß½ng trþ, huynh ð® nh¸ nhân giai dî mi­n d¸ch thß½ng hÕi. Nhßþc nång phá trúc, t¡c ð¯i Ñng phòng ngñ khä b¸ mi­n tr×." )
