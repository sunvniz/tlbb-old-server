...
x500007_g_Signpost = {
	{ type=2, name="Nguy®t lão lão nhân", x=46, y=62, tip="Nguy®t Lão ", desc="Nguy®t lão lão nhân · góc Tây B¡c trong thành LÕc Dß½ng. mu¯n ngß¶i m¾i t± chÑc hôn l­, cÑ tìm ông. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
