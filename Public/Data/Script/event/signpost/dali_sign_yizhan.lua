...
x500043_g_Signpost = {
	{ type=2, name="D¸ch trÕm", x=241, y=136, tip="Thôi Phùng CØu ", desc="Ðß¶ng xa vÕn d£m, nát vÕn cu¯n thß, mu¯n thåm thú các n½i khác, D¸ch trÕm là n½i thu§n ti®n nh¤t. Lão Thôi · D¸ch trÕm · tÕi hß¾ng B¡c ðß¶ng l¾n phía Ðông. „n phím TAB, trên bän ð° có ký hi®u nh¤p nháy", eventId=-1 },
}
