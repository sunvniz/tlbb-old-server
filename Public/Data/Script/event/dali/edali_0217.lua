...
--ÈÎÎñÐúng·ñÒÑ¾­Íê³É
x210217_g_IsMissionOkFail = 0		--±äÁ¿toÕ ðµ µÚ0Î»
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x210217_OnDefaultEvent( sceneId, selfId, targetId )	-- ði¬m»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
...
function x210217_OnAccept( sceneId, selfId )
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x210217_g_MissionId)			-- ði¬mµ½ÈÎÎñtoÕ ðµ ÐòÁÐºÅ
