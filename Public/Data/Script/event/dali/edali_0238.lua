...
x210238_g_IsMissionOkFail = 0		--±äÁ¿toÕ ğµ µÚ0Î»
--ÈÎÎñÃû
...
x210238_g_Custom	= { {id="Ğã ğÕt ğÆng c¤p",num=10} }--±äÁ¿toÕ ğµ µÚ1Î»
...
function x210238_OnAccept( sceneId, selfId )
	...
	--local misIndex = GetMissionIndexByID(sceneId, selfId, x210238_g_MissionId)-- ği¬mµ½ÈÎÎñTÕi 20cáiÈÎÎñÖĞtoÕ ğµ ĞòÁĞºÅ
	--SetMissionByIndex(sceneId,selfId,misIndex,0,0)					--¸ù¾İĞòÁĞºÅ°ÑÈÎÎñ±äÁ¿toÕ ğµ µÚmµt Î»ÖÃ0	µÚmµt Î»ĞúngÍê³É/th¤t bÕiÇé¿ö

	--Msg2Player(  sceneId, selfId,"#YTiªp thøÈÎÎñ" .. x210238_g_MissionName, MSG2PLAYER_PARA )
