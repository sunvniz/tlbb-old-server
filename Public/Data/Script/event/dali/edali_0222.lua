...
x210222_g_MissionTarget="Vào cØa sau cüa Hoa Viên. "	--Møc tiêu nhi®m vø
x210222_g_ContinueInfo="Vào cØa sau cüa Hoa Viên. "	--Î´Hoàn t¤t nhi®m vøtoÕ ğµ npc¶Ô»°
x210222_g_MissionComplete="  Nhi®m vø hoàn thành"	--Hoàn t¤t nhi®m vønpcËµ»°toÕ ğµ »°
x210222_g_SignPost = {x = 275, z = 50, tip = "Hoàng Mi Tång "}
x210222_g_PetDataID=558	--ÈÎÎñ³èÎïtoÕ ğµ ±àºÅ

--½ÇÉ«Mission±äÁ¿Ë ği¬m÷
x210222_g_Param_huan		=0	--0ºÅ: ÒÑ¾­Íê³ÉtoÕ ğµ »·Êı,TÕi ½ÓÊÕÈÎÎñÊ±ºò¸³Öµ
x210222_g_IsMissionOkFail	=1	--1ºÅ: µ±Ç°ÈÎÎñĞúng·ñÍê³É(0Î´Íê³É£»1Íê³É)
x210222_g_Param_sceneid		=2	--2ºÅ: µ±Ç°¸±±¾ÈÎÎñtoÕ ğµ ³¡¾°ºÅ
x210222_g_Param_guid		=3	--3ºÅ: ½Ó¸±±¾ÈÎÎñÊ±ºòtoÕ ğµ Íæ¼ÒGUID
x210222_g_Param_killcount	=4	--4ºÅ: É±ËÀÈÎÎñ¹ÖtoÕ ğµ ÊıÁ¿
x210222_g_Param_time		=5	--5ºÅ: Íê³É¸±±¾ËùÓÃÊ±¼ä(µ¥Î»:  giây)
--6ºÅ: Î´ÓÃ
--7ºÅ: Î´ÓÃ
...
x210222_g_CopySceneType=FUBEN_MURENXIANG_7	--¸±±¾ÀàĞÍ,¶¨ÒåTÕi ScriptGlobal.luaÀïÃæ
x210222_g_LimitMembers=1			--¿ÉÒÔ½ø¸±±¾toÕ ğµ ×îĞ¡¶ÓÎéÈËÊı
x210222_g_TickTime=5				--»Øµ÷½Å±¾toÕ ğµ Ê±ÖÓÊ±¼ä(µ¥Î»:  giây/´Î)
x210222_g_LimitTotalHoldTime=360	--¸±±¾¿ÉÒÔ´æ»îtoÕ ğµ Ê±¼ä(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÔòÈÎÎñ½«»áth¤t bÕi
x210222_g_LimitTimeSuccess=500		--¸±±¾Ê±¼äÏŞÖÆ(µ¥Î»: ´ÎÊı),Èç¹û´ËÊ±¼äµ½ÁË,ÈÎÎñÍê³É
x210222_g_CloseTick=6				--¸±±¾¹Ø±ÕÇ°µ¹¼ÆÊ±(µ¥Î»: ´ÎÊı)
x210222_g_NoUserTime=300			--¸±±¾ÖĞÃ»ÓĞÈËºó¿ÉÒÔ¼ÌĞø±£´ætoÕ ğµ Ê±¼ä(µ¥Î»:  giây)
x210222_g_DeadTrans=0				--ËÀÍö×ªÒÆÄ£Ê½,0: ËÀÍöºó»¹¿ÉÒÔ¼ÌĞøTÕi ¸±±¾,1: ËÀÍöºó±»Ç¿ÖÆÒÆ³ö¸±±¾
x210222_g_Fuben_X=44				--½øÈë¸±±¾toÕ ğµ Î»ÖÃX
x210222_g_Fuben_Z=54				--½øÈë¸±±¾toÕ ğµ Î»ÖÃZ
x210222_g_Back_X=275				--Ô´³¡¾°Î»ÖÃX
x210222_g_Back_Z=50					--Ô´³¡¾°Î»ÖÃZ
x210222_g_TotalNeedKill=0			--C¥n É±ËÀ¹ÖÎïÊıÁ¿
x210222_g_MissionIdPre=701			--C¥n ÌáÇ°ÓµÓĞtoÕ ğµ ÈÎÎñ

--**********************************
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x210222_OnDefaultEvent( sceneId, selfId, targetId )
	if IsHaveMission(sceneId,selfId,x210222_g_MissionId) > 0  then	--Èç¹ûÍæ¼ÒÒÑ¾­½ÓÁËCái này ÈÎÎñ
		...
		elseif bDone==1 then					--ÈÎÎñÒÑ¾­Íê³É
			BeginEvent(sceneId)
				...
				--AddText(sceneId,"Äã½« ği¬mµ½: ")
				--AddMoneyBonus(sceneId,x210222_g_MoneyBonus)
			EndEvent( )
			DispatchMissionDemandInfo(sceneId,selfId,targetId,x210222_g_ScriptId,x210222_g_MissionId,bDone)
		end
    elseif x210222_CheckAccept(sceneId,selfId) > 0 then		--Ã»ÓĞÈÎÎñ,Thöa mãnÈÎÎñ½ÓÊÕÌõ¼ş
...
function x210222_CheckAccept( sceneId, selfId )
	...
	local petcount = LuaFnGetPetCount(sceneId, selfId) --È¡ ği¬m³èÎïÊıÁ¿
	for	i=0,petcount-1 do
		petdataid = LuaFnGetPet_DataID(sceneId, selfId, i) --È¡ ği¬m³èÎï±àºÅ
...
function x210222_OnAccept( sceneId, selfId )
	...
	if( IsHaveMission(sceneId,selfId,x210222_g_MissionId) > 0)  then	--ÒÑ¾­ÓĞÈÎÎñtoÕ ğµ 
		misIndex = GetMissionIndexByID(sceneId,selfId,x210222_g_MissionId)
...
function x210222_MakeCopyScene( sceneId, selfId, nearmembercount )
	...
	LuaFnSetSceneLoad_Map(sceneId, x210222_g_CopySceneMap); --µØÍ¼Ğúng±ØĞëÑ¡È¡toÕ ğµ ,¶øÇÒ±ØĞëTÕi Config/SceneInfo.iniÀïÅäÖÃºÃ
	...
	LuaFnSetCopySceneData_Param(sceneId, 0, x210222_g_CopySceneType);--ÉèÖÃ¸±±¾Êı¾İ,ÕâÀï½«0ºÅË÷ÒıtoÕ ğµ Êı¾İÉèÖÃÎª999,ÓÃÓÚ±íÊ¾¸±±¾ºÅ999(Êı×Ö×Ô¶¨Òå)
	...
	LuaFnSetSceneLoad_Monster(sceneId, x210222_g_CopySceneMonster)	--7c¤pºó»¨Ô°×½³è¸±±¾
...
function x210222_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	if x210222_CheckSubmit( sceneId, selfId, selectRadioId )>0 then		-- ÒÑ¾­Hoàn t¤t nhi®m vøÁË
		--Ìí¼ÓÈÎÎñ½±Àø
...
function x210222_OnCopySceneReady( sceneId, destsceneId )
	...
	if LuaFnIsCanDoScriptLogic( sceneId, leaderObjId ) == 1 then			-- ´¦ÓÚ¿ÉÒÔÖ´ĞĞÂß¼­toÕ ğµ ×´Ì¬
...
function x210222_OnCopySceneTimer( sceneId, nowTime )
	...
	elseif TickCount == x210222_g_LimitTotalHoldTime then --¸±±¾×ÜÊ±¼äÏŞÖÆµ½ÁË
		...
		for	i=0,membercount-1 do
			mems[i] = LuaFnGetCopyScene_HumanObjId(sceneId,i)
			DelMission( sceneId, mems[i], x210222_g_MissionId );--ÈÎÎñth¤t bÕi,É¾³ıÖ®
