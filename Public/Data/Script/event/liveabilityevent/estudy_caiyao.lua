...
--Ñ§Ï°½çÃæÒªËµtoÕ ðµ »°
x713509_g_MessageStudy = "Nªu các hÕ ðÕt t¾i c¤p %d và phäi tiêu t¯n #{_MONEY%d} m¾i có th¬ h÷c ðßþc kÛ nång hái thu¯c. Các hÕ có quyªt ð¸nh h÷c không?"
...
function x713509_OnDefaultEvent( sceneId, selfId, targetId, ButtomNum,g_Npc_ScriptId,bid )
	...
	--ÅÐ¶ÏÐúng·ñÒÑ¾­Ñ§»áÁË²ÉÒ©,Èç¹ûÑ§»áÁË,ÔòÌáÊ¾ÒÑ¾­Ñ§»áÁË
...
function x713509_StudyInCity(sceneId, selfId, targetId, ButtomNum,g_Npc_ScriptId,bid)
	if bid then
		if 0 == ButtomNum then
			...
			local studyMsg = format("Nªu các hÕ ðÕt t¾i c¤p %d, phäi tiêu t¯n #{_MONEY%d} và %d ði¬m bang hµi s¨ có th¬ h÷c ðßþc"..x713509_g_AbilityName.."KÛ nång. Ngß½i quyªt ð¸nh h÷c cái gì?", lv, money, con)
