...
x713612_g_button = {"Ğßşc r°i, ğßşc r°i, nói gì thñc tª ği",
...
--ÈÎÎñÈë¿Úº¯Êı
--**********************************
function x713612_OnDefaultEvent( sceneId, selfId, targetId, MessageNum )	--MessageNumĞúng¶Ô»°±àºÅ,ÓÃÓÚµ÷ÓÃ²»Í¬¶Ô»°
		BeginEvent(sceneId)
...
function x713612_OnEnumerate( sceneId, selfId, targetId )
		AddNumText(sceneId,x713612_g_ScriptId,"TÕi hÕ mu¯n tìm hi¬u tr°ng tr÷t",11,-1)
end
