...
function x713591_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if AbilityLevel < 1	then
		BeginEvent(sceneId)
			strText = "Ngß½i vçn chßa h÷c kÛ nång Thái bång thu§t"
...
function x713591_OnEnumerate( sceneId, selfId, targetId )
		...
		if 1 then
			AddNumText(sceneId,x713591_g_ScriptId,"Thång c¤p kÛ nång Thái bång thu§t", 12, 1)
		end
		return
end
