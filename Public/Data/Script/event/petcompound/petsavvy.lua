...
function x800104_OnEnumerate( sceneId, selfId, targetId )
	AddNumText( sceneId, x800104_g_ScriptId, "Thång c¤p ngµ tính trân thú" ,6,-1)
end
...
function x800104_PetSavvy( sceneId, selfId, mainPetGuidH, mainPetGuidL, assisPetGuidH, assisPetGuidL )
	...
	if gengu ==0 then
		BeginEvent( sceneId )
			AddText( sceneId, "Cån C¯t cüa thú tham gia hþp thành = 0, không th¬ gia tång ngµ tính trân thú." )
		EndEvent( sceneId )
