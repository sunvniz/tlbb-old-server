...
--Óù´ÍÌ×Òıµ¼ÈÎÎñ_ÌìÊ¦toÕ ğµ ÆÚ´ı8
...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x500614_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»

--ÈÎÎñÎÄ±¾ÃèÊö
x500614_g_MissionName			= "Thiên sß kì ğãi [8]"
--ÈÎÎñÃèÊö
...
x500614_g_Custom	= { {id="Ğa thång lên c¤p 45",num=1} }
--MisDescEnd

--ÈÎÎñĞúng·ñÍê³É
x500614_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--Ğúng·ñ´ïµ½µÈc¤ptoÕ ğµ ±ê¼Ç
x500614_g_RecordIdx 				 = 1		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ1Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x500614_g_MissScriptID_Idx	 = 2		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ2Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x500614_g_AcceptNPC_Idx			 = 3		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ3Î» 1.LÕc Dß½ngNPC

x500614_g_AcceptMission_IDX		= 783	--½ÓÊÕÈÎÎñË÷Òı
x500614_g_CompleteMission_IDX	= 784	--Ìá½»ÈÎÎñË÷Òı

--ËùÓµÓĞtoÕ ğµ ÊÂ¼şIDÁĞ±í
x500614_g_EventList	= {}

x500614_g_PlayerSlow_LVL					 = 42		-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x500614_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x500614_g_AcceptMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500614_g_Name then
			x500614_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- ÈÎÎñĞúng·ñÒÑÂú
	...
	elseif key == x500614_g_CompleteMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500614_g_AccomplishNPC_Name then
			x500614_NotifyTip( sceneId, selfId, "Trä nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- Èç¹ûÒÑ¾­½ÓÁËÈÎÎñ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x500614_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
end
