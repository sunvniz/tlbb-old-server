--´´½¨ÈË[ QUFEI 2008-04-30 10:27 UPDATE BugID 34164 ]
--½â¾öÁ÷Ê§ÂÊÒıµ¼ÈÎÎñÊÂ¼ş½Å±¾
--×é¶ÓÒıµ¼ÈÎÎñ2_Á·Ï°×é¶Ó
...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x500600_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»

--ÈÎÎñÎÄ±¾ÃèÊö
x500600_g_MissionName			= "Luy®n t§p t± ğµi"
--ÈÎÎñÃèÊö
...
x500600_g_Custom	= { {id="Ğã l§p t± ğµi hai ngß¶i",num=1} }
--MisDescEnd

--ÈÎÎñĞúng·ñÍê³É
x500600_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--Ğúng·ñ×é¶ÓtoÕ ğµ ±ê¼Ç
x500600_g_RecordIdx 				 = 1		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ1Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x500600_g_MissScriptID_Idx	 = 2		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ2Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x500600_g_AcceptNPC_Idx			 = 3		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ3Î» 1.LÕc Dß½ngNPC

x500600_g_AcceptMission_IDX		= 743	--½ÓÊÕÈÎÎñË÷Òı
x500600_g_CompleteMission_IDX	= 744	--Ìá½»ÈÎÎñË÷Òı

--ËùÓµÓĞtoÕ ğµ ÊÂ¼şIDÁĞ±í
x500600_g_EventList	= {}

x500600_g_PlayerSlow_LVL					 = 26		-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x500600_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if key == x500600_g_AcceptMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500600_g_Name then
			x500600_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- ÈÎÎñĞúng·ñÒÑÂú
	...
	elseif key == x500600_g_CompleteMission_IDX then
		...
		if LuaFnGetName( sceneId, targetId ) ~= x500600_g_AccomplishNPC_Name then
			x500600_NotifyTip( sceneId, selfId, "Trä nhi®m vø th¤t bÕi" )					
			return 0
		end
		-- Èç¹ûÒÑ¾­½ÓÁËÈÎÎñ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x500600_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
end
