...
x895088_MyName			= "Mµ dung phøc"	--×Ô¼ºµÄÃû×Ö....
...
function x895088_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x895088_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân s· hoán #c2ebeff"..GetName( sceneId, selfId ).." dî b¸ kích phá, cách ngÕn ð°ng s¡c chi trúc dî vô pháp t°i hüy." )
