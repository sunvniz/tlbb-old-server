...
x895066_MyName			= "Da Lu§t Di­m"	--×Ô¼ºµÄÃû×Ö....
...
x895066_LootItem_1 = {
39910002, 39910003, 39910004,--3Ç§ 5Ç§ 8Ç§ ÔùµãÆ±
}

x895066_LootItem_2 = {
30308121, 30308122, 30308123, 30308124, 30308125,
30308126, 30308127, 30308128,30308129, 		--80Ç¿¿Ø
}
--**********************************
--³õÊ¼»¯....
--**********************************
...
function x895066_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format(" #{_INFOUSR%s}#P dám xßng #GThiên HÕ Ğ® Nh¤t#P, ai dám không tuân!", playerName); --ÎÚÀÏ´ó
...
function x895066_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Di­m", "Binh thánh kÏ tr§n", "Da Lu§t Di­m: Giang h° loÕn lÕc ch½i Thiên Long" )
	CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: Ğ°ng Sinh Cµng TØ " )
...
function x895066_UseSkillH( sceneId, selfId )
	...
	--Ê¹ÓÃ¿Õ¼¼ÄÜ....
		...
		CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Di­m", "Binh thánh kÏ tr§n", "Da Lu§t Di­m: H± xu¯ng ğ°ng b¢ng b¸ chó khinh!" )
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Chó lên mi«n núi b¸ h± x½i!" )
...
function x895066_UseSkillI( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Di­m", "Binh thánh kÏ tr§n", "Da Lu§t Di­m: #c2ebeff"..GetName( sceneId, PlayerIdA )..","..GetName( sceneId, PlayerIdB ).."#W võ công quá kém!" )
	CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Lång Ba Vi Bµ" )
...
function x895066_UseSkillJ( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Di­m", "Binh thánh kÏ tr§n", "Da Lu§t Di­m: Xuân Phong Dß Tuyªt" )
	CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  TØ MÕch H°ng Tr¥n" )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Di­m", "Binh thánh kÏ tr§n", "Da Lu§t Di­m: Thßşng C± Th¥n Binh" )
	CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: Trùng Lâu Quy Tø " )
...
function x895066_OnBQZTimer( sceneId, step, data1, data2 )
	...
	if 15 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "15 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 13 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "13 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 10 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "10 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 7 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "7 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 6 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "6 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 5 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "5 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 4 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "4 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 3 == step then
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "3 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end

	if 2 == step then
		--ÌáÊ¾Õ½¶·¿ªÊ¼....
		CallScriptFunction( x895066_g_FuBenScriptId, "TipAllHuman", sceneId, "2 giây sau b¡t ğ¥u tr§n höa lñc kh·i ğµng, chß v¸ khüng tao ğ¯t ngß¶i chi kiªp, hoàn thïnh t¯c t¯c tìm kiªm thüy tích ch² ğ¬ tránh xâm lßşc höa t§p." )
		return
	end
