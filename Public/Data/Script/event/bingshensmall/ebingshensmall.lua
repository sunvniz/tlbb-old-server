...
x895063_g_CopySceneType = FUBEN_BINGSHENZHEN	--¸±±¾ÀàÐÍ ¶¨ÒåÔÚScriptGlobal.luaÀïÃæ

x895063_g_TickTime		= 1				--»Øµ÷½Å±¾µÄÊ±ÖÓÊ±¼ä£¨µ¥Î»£ºÃë/´Î£©
x895063_g_NoUserTime	= 10			--¸±±¾ÖÐÃ»ÓÐÈËºó¿ÉÒÔ¼ÌÐø±£´æµÄÊ±¼ä£¨µ¥Î»£ºÃë£©
x895063_g_Fuben_X			= 123			--½øÈë¸±±¾µÄÎ»ÖÃX
x895063_g_Fuben_Z			= 138			--½øÈë¸±±¾µÄÎ»ÖÃZ
x895063_g_FuBenTime		= 3*60*60	--¸±±¾¹Ø±ÕÊ±¼ä....

--BOSS±í....
x895063_g_BOSSList =
{
	["XiaoYiFeng_NPC"]				= { DataID=15006, Title="Tiêu D§t Phong", posX=51, posY=53, Dir=27, BaseAI=3, AIScript=0, ScriptID=895070 },
	["XiaoYiFeng_BOSS"]				= { DataID=15010, Title="Tiêu D§t Phong", posX=51, posY=53, Dir=27, BaseAI=27, AIScript=301, ScriptID=895064 },
	...
	["XiaoRuJun_NPC"]		= { DataID=15026, Title="Tiêu Nhß Quân", posX=173, posY=36, Dir=0, BaseAI=3, AIScript=0, ScriptID=895071 },
	["XiaoRuJun_BOSS"]		= { DataID=15030, Title="Tiêu Nhß Quân", posX=173, posY=36, Dir=0, BaseAI=27, AIScript=0, ScriptID=895065 },
	["XiaoRuWei_NPC"]		= { DataID=15031, Title="Tiêu Nhß Quân", posX=173, posY=100, Dir=0, BaseAI=3, AIScript=0, ScriptID=895068 },
	["XiaoRuWei_BOSS"]		= { DataID=15035, Title="Tiêu Nhß Quân", posX=173, posY=100, Dir=0, BaseAI=27, AIScript=0, ScriptID=895067 },

	["ZhuBai_BOSS"]			= { DataID=15040, Title="Ð°ng Tâm Trúc - BÕch", posX=169, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=895080 },
	["ZhuHong_BOSS"]			= { DataID=15060, Title="Ð°ng Tâm Trúc - H°ng", posX=173, posY=32, Dir=0, BaseAI=28, AIScript=0, ScriptID=895083 },
	["ZhuHuang_BOSS"]			= { DataID=15050, Title="Ð°ng Tâm Trúc - Hoàng", posX=177, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=895082 },
	["ZhuLan_BOSS"]			= { DataID=15065, Title="Ð°ng Tâm Trúc - Lam", posX=176, posY=39, Dir=0, BaseAI=28, AIScript=0, ScriptID=895084 },
	["ZhuLv_BOSS"]			= { DataID=15055, Title="Ð°ng Tâm Trúc - Løc", posX=170, posY=33, Dir=0, BaseAI=28, AIScript=0, ScriptID=895085 },
	["ZhuZi_BOSS"]			= { DataID=15045, Title="Ð°ng Tâm Trúc - TØ", posX=173, posY=38, Dir=0, BaseAI=28, AIScript=0, ScriptID=895081 },

	["Bai_BOSS"]			= { DataID=15140, Title="Ð°ng Tâm Trúc - BÕch", posX=169, posY=100, Dir=0, BaseAI=28, AIScript=0, ScriptID=895086 },
	["Hong_BOSS"]			= { DataID=15160, Title="Ð°ng Tâm Trúc - H°ng", posX=173, posY=97, Dir=0, BaseAI=28, AIScript=0, ScriptID=895089 },
	["Huang_BOSS"]			= { DataID=15150, Title="Ð°ng Tâm Trúc - Hoàng", posX=177, posY=98, Dir=0, BaseAI=28, AIScript=0, ScriptID=895088 },
	["Lan_BOSS"]			= { DataID=15165, Title="Ð°ng Tâm Trúc - Lam", posX=176, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=895090 },
	["Lv_BOSS"]			= { DataID=15155, Title="Ð°ng Tâm Trúc - Løc", posX=175, posY=104, Dir=0, BaseAI=28, AIScript=0, ScriptID=895091 },
	["Zi_BOSS"]			= { DataID=15145, Title="Ð°ng Tâm Trúc - TØ", posX=173, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=895087 },

	["YeLvYan_NPC"]				= { DataID=15071, Title="Da Lu§t Di­m", posX=192, posY=195, Dir=27, BaseAI=3, AIScript=0, ScriptID=895072 },
	["YeLvYanLoss_NPC"]		= { DataID=14216, Title="", posX=117, posY=49, Dir=0, BaseAI=3, AIScript=0, ScriptID=895075 },
	["YeLvYan_BOSS"]			= { DataID=15075, Title="Da Lu§t Di­m", posX=192, posY=195, Dir=27, BaseAI=27, AIScript=0, ScriptID=895066 },
	...
	["LiFan_NPC"]				= { DataID=15086, Title="Da Lu§t Liên Thành", posX=52, posY=203, Dir=27, BaseAI=3, AIScript=0, ScriptID=895075 },
	["YeLvLian_BOSS"]		= { DataID=15090, Title="Da Lu§t Liên Thành", posX=52, posY=203, Dir=27, BaseAI=27, AIScript=0, ScriptID=895069 },

	["ShiDui_BOSSA"]			= { DataID=15095, Title="Mi­n D¸ch NgoÕi Công", posX=52, posY=218, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSB"]			= { DataID=15095, Title="Mi­n D¸ch NgoÕi Công", posX=63, posY=213, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSC"]			= { DataID=15095, Title="Mi­n D¸ch NgoÕi Công", posX=67, posY=203, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSD"]			= { DataID=15095, Title="Mi­n D¸ch NgoÕi Công", posX=63, posY=192, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSE"]			= { DataID=15095, Title="Mi­n D¸ch Nµi Công", posX=53, posY=188, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSF"]			= { DataID=15095, Title="Mi­n D¸ch Nµi Công", posX=42, posY=192, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSG"]			= { DataID=15095, Title="Mi­n D¸ch Nµi Công", posX=38, posY=203, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["ShiDui_BOSSH"]			= { DataID=15095, Title="Mi­n D¸ch Nµi Công", posX=42, posY=213, Dir=0, BaseAI=28, AIScript=0, ScriptID=-1 },
	["TieGu_BOSS"]			= { DataID=15085, Title="Mi­n D¸ch NgoÕi Công", posX=0, posY=0, Dir=0, BaseAI=28, AIScript=0, ScriptID=895092 },
	["YuanShen_BOSS"]			= { DataID=15100, Title="Mi­n D¸ch Nµi Công", posX=0, posY=0, Dir=0, BaseAI=28, AIScript=0, ScriptID=895093 },
...
x895063_g_IDX_FuBenOpenTime		= 13	--¸±±¾½¨Á¢µÄÊ±¼ä....
x895063_g_IDX_FuBenLifeStep		= 14	--¸±±¾ÉúÃüÆÚµÄstep....(°üÀ¨½¨Á¢NPC....¹Ø±Õµ¹¼ÆÊ±ÌáÊ¾....)
...
function x895063_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BroadMsgByChatPipe( sceneId, selfId, ""..nam.."#gff00f0 tÕi #gffff00Binh thánh kÏ tr§n#gff00f0 hÕ sát Da Lu§t Liên Thành !", 4 )
...
function x895063_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x895063_g_ScriptId, "Binh thánh kÏ tr§n (Thß¶ng)", 10, 1 )
...
function x895063_CheckCanEnter( sceneId, selfId, targetId )
	...
	if GetTeamSize(sceneId,selfId) < 2 then
		return 0, "C¥n mµt t± ðµi 2 ngß¶i m¾i có th¬ tham gia!"
	end
	...
	if nHumanNum > 0 then
		...
		local msg = "    Trong ðµi có "
		for i=0, nHumanNum-2 do
			msg = msg .. Humanlist[i] .. " "
		end
		msg = msg .. Humanlist[nHumanNum-1] .. " d?ng c?p chua d? 100"
		return 0, msg
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. " hôm nay ðã khiêu chiªn quá 3 l¥n!"
		return 0, msg
...
function x895063_MakeCopyScene( sceneId, selfId )
	...
	BeginEvent(sceneId)
		if bRetSceneID>0 then
			...
			AddText(sceneId,"S¯ lßþng bän sao ðã ðÕt gi¾i hÕn, hãy ðþi tý nhé!");
		end
	EndEvent(sceneId)
...
function x895063_OnCopySceneReady( sceneId, destsceneId )
	...
	for	i=0,nearteammembercount-1 do
		...
		if lastDayCount >= 3 then
			BeginEvent( sceneId )
				AddText( sceneId, "  Hôm nay ðã khiêu chiªn quá s¯ l¥n quy ð¸nh!" )
			EndEvent( sceneId )
			DispatchEventList( sceneId, selfId, targetId )
		return
		end
...
function x895063_CheckHaveBOSS( sceneId )
	...
	if nBossNum > 0 then
		local msg = "Ðang cùng v¾i "
		for i=0, nBossNum-2 do
			msg = msg .. BossList[i] .. " "
		end
		msg = msg .. BossList[nBossNum-1] .. " quyªt mµt tr§n sinh tØ"
		return 1, msg
	end
