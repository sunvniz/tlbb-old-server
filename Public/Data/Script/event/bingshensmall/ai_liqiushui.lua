...
--ÃâÒßBuff....
x895069_Buff_MianYi1	= 10472	--ÃâÒßÒ»Ğ©¸ºÃæĞ§¹û....
x895069_Buff_MianYi2	= 10471	--ÃâÒßÆÕÍ¨ÒşÉí....

--¼¼ÄÜ....
x895069_SkillID_F		= 1820  --ÆÕÍ¨¹¥»÷
...
x895069_MyName			= "Da Lu§t Liên Thành"	--×Ô¼ºµÄÃû×Ö....

--AI Index....
x895069_IDX_KuangBaoMode	= 1	--¿ñ±©Ä£Ê½....0Î´¿ñ±© 1ĞèÒª½øÈë¿ñ±© 2ÒÑ¾­½øÈë¿ñ±©
x895069_IDX_CD_SkillFH		= 2	--FH¼¼ÄÜµÄCD....
x895069_IDX_CD_SkillG			= 3	--G¼¼ÄÜµÄCD....
x895069_IDX_CD_Talk				= 4	--FH¼¼ÄÜº°»°µÄCD....
x895069_IDX_CD_SkillJ			= 5	--G¼¼ÄÜµÄCD....
x895069_IDX_CD_SkillH			= 6	--G¼¼ÄÜµÄCD....
x895069_IDX_CD_SkillK			= 7	--G¼¼ÄÜµÄCD....

x895069_IDX_CombatFlag 		= 1	--ÊÇ·ñ´¦ÓÚÕ½¶·×´Ì¬µÄ±êÖ¾....
...
function x895069_OnDie( sceneId, selfId, killerId )
	...
	if playerName ~= nil then
		str = format("#GDa Lu§t Liên Thành#W vô ğ¯i! #{_INFOUSR%s}#P ta không nghî v§y!", playerName); --ÀîÇïË®
...
function x895069_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Liên Thành", "Binh thánh kÏ tr§n", "Da Lu§t Liên Thành: Thiên Ğ¸a Ğ°ng Th÷! " )
	CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Chiªt Mai Thü!" )
...
function x895069_UseSkillH( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Liên Thành", "Binh thánh kÏ tr§n", "Da Lu§t Liên Thành: Hoành Täo Càn Khôn!" )
	CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Da Lu§t Liên Thành - Thiªt C¯t: Nµ Höa Liên Träm" )
	CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Bµ Bµ Sinh Hoa" )
	CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Phong Höa Liên Thành " )
...
function x895069_UseSkillJ( sceneId, selfId )
	...
	CallScriptFunction((200060), "Paopao",sceneId, "Da Lu§t Liên Thành", "Binh thánh kÏ tr§n", "Da Lu§t Liên Thành: Thanh Tâm Ph± Thi®n Chú!" )
	CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  30 giây næa không hÕ thü ğßşc Gia Lu§t Liên Thành thì tính mÕng khó giæ!" )
...
function x895069_OnBQZTimer( sceneId, step, data1, data2 )
	...
	if 20 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 20 giây næa không hÕ thü ğßşc Gia Lu§t Liên Thành thì tính mÕng khó giæ!" )
		return
	end

	if 15 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: Thôn thiên thÕch dî thành tr§n quá bán, tái sinh ngû t÷a ngã ğÆng ti®n tß½ng m®nh quy tây thiên.15 mi¬u nµi v¸ nång tß½ng Da Lu§t Liên Thành kích sát, th§p t÷a thôn thiên thÕch ti®n tß½ng liên th¬ thành tr§n, ngã ğÆng ğ¸nh hµi tính m®nh b¤t bäo!" )
		return
	end

	if 10 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 10 giây næa không hÕ thü ğßşc Gia Lu§t Liên Thành thì tính mÕng khó giæ!" )
		return
	end

	if 6 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 6 mi¬u nµi v¸ nång tß½ng Da Lu§t Liên Thành kích sát, th§p t÷a thôn thiên thÕch ti®n tß½ng liên th¬ thành tr§n, ngã ğÆng ğ¸nh hµi tính m®nh b¤t bäo." )
		return
	end

	if 5 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 5 mi¬u nµi v¸ nång tß½ng Da Lu§t Liên Thành kích sát, th§p t÷a thôn thiên thÕch ti®n tß½ng liên th¬ thành tr§n, ngã ğÆng ğ¸nh hµi tính m®nh b¤t bäo." )
		return
	end

	if 4 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 4 mi¬u nµi v¸ nång tß½ng Da Lu§t Liên Thành kích sát, th§p t÷a thôn thiên thÕch ti®n tß½ng liên th¬ thành tr§n, ngã ğÆng ğ¸nh hµi tính m®nh b¤t bäo." )
		return
	end

	if 3 == step then
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 3 mi¬u nµi v¸ nång tß½ng Da Lu§t Liên Thành kích sát, th§p t÷a thôn thiên thÕch ti®n tß½ng liên th¬ thành tr§n, ngã ğÆng ğ¸nh hµi tính m®nh b¤t bäo." )
		return
	end

	if 2 == step then
		--ÌáÊ¾Õ½¶·¿ªÊ¼....
		CallScriptFunction( x895069_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói: 2 giây næa không hÕ thü ğßşc Gia Lu§t Liên Thành thì tính mÕng khó giæ!" )
		return
	end
