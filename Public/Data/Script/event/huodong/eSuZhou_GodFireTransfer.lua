...
--Tô ChâuNhi®m vø Rùa-Thö thi chÕyÊÂ¼ş½Å±¾
...
--ÈÎÎñĞúng·ñÒÑ¾­Íê³É
x808081_g_IsMissionOkFail	= 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»

--ÈÎÎñÎÄ±¾ÃèÊö
x808081_g_MissionName			= "Nhi®m vø Rùa-Thö thi chÕy"
--ÈÎÎñÃèÊö
...
--Ã¿´ÎRùa-Thö thi chÕy´«µİ»î¶¯C¥n ´ò¿¨toÕ ğµ Thành th¸×ÜÊı
x808081_g_MaxRound	= 3
--¿ØÖÆ½Å±¾
x808081_g_ControlScript		= 001066

-- ÈÎÎñÍê³ÉÇé¿ö,ÄÚÈİ¶¯Ì¬Ë¢ĞÂ,·Ö±ğÕ¼ÓÃÈÎÎñ²ÎÊıtoÕ ğµ µÚ1,2,3,4Î»
x808081_g_Custom	= { {id="Ğã cùng LÕc Dß½ng Tri®u Minh Thành ğ¯i thoÕi",num=1}, {id="Ğã cùng Tô Châu Løc Sî Tranh ğ¯i thoÕi",num=1}, {id="Ğã cùng ĞÕi Lı Vß½ng Nhßşc Vû ğ¯i thoÕi",num=1}, {id="Ğã châm toàn bµ ğèn Kh±ng Minh",num=24} }
--MisDescEnd

--ÈÎÎñĞúng·ñÍê³É
x808081_g_Mission_IsComplete = 0		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ0Î»
--»ğ°ÑTô Châu´ò¿¨±ê¼Ç
x808081_g_RecordIdx 				 = 2		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ2Î» 1.LÕc Dß½ng 2.Tô Châu 3.ĞÕi Lı
--¿×Ã÷µÆÍê³ÉÊıÁ¿±ê¼Ç
x808081_g_KongMing_Lighten	 = 4		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ4Î»
--ÈÎÎñ½Å±¾ºÅ¼ÇÂ¼
x808081_g_MissScriptID_Idx	 = 5		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ5Î»
--ÈÎÎñ·¢²¼NPC±ê¼Ç
x808081_g_AcceptNPC_Idx			 = 6		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ6Î» 1.LÕc Dß½ngNPC 2.Tô ChâuNPC 3.ĞÕi LıNPC
--Nhi®m vø Rùa-Thö thi chÕyÃ¿ÌìÂÖÊı±ê¼Ç
x808081_g_RoundIndex 				 = 7		--ÈÎÎñ²ÎÊıtoÕ ğµ µÚ7Î»


x808081_g_AcceptMission_IDX		= 620	--»ğ°Ñ½ÓÊÕÈÎÎñË÷Òı
x808081_g_CompleteMission_IDX	= 621	--»ğ°ÑÌá½»ÈÎÎñË÷Òı
x808081_g_MissionInfo_IDX			= 622	--ÈÎÎñË ği¬m÷Ë÷Òı

x808081_g_Jion_Count = 0						--±¨ÃûÈËÊı±ê¼Ç
x808081_g_Join_CountMax = 50				--±¨ÃûÈËÊıÉÏÏŞ

x808081_g_KongMingLighten_MaxCnt	=	24	-- Rùa-Thö thi chÕy»î¶¯C¥n  ği¬mÈ¼toÕ ğµ ¿×Ã÷µÆ×ÜÊı

--ËùÓµÓĞtoÕ ğµ ÊÂ¼şIDÁĞ±í
x808081_g_EventList	= {}

x808081_g_Impact_Accept_Mission 	= 47	-- Tiªp thøÈÎÎñÊ±toÕ ğµ ÌØĞ§ID
x808081_g_Impact_Light_Complete 	= 38	--  ği¬mÁÁ¿×Ã÷µÆÊ±toÕ ğµ ÌØĞ§
x808081_g_Impact_Transport_Mission = 113 -- ÔËÊä×´Ì¬ÌØĞ§
x808081_g_Impact_GodOfFire_Mission = 5929 -- Rùa-Thö thi chÕy×´Ì¬ÌØĞ§
x808081_g_PlayerSlow_LVL					= 20	-- Tiªp thøÈÎÎñtoÕ ğµ ×îµÍµÈc¤p
...
function x808081_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if LuaFnGetName( sceneId, targetId ) ~= x808081_g_Name then
		x808081_NotifyTip( sceneId, selfId, "Nh§n nhi®m vø th¤t bÕi" )					
		return 0
	end
...
function x808081_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x808081_g_ScriptId, "Ta mu¯n tham giaRùa-Thö thi chÕy", 7, x808081_g_AcceptMission_IDX )
	AddNumText( sceneId, x808081_g_ScriptId, "Ta ğã mu¯n hoàn thành Rùa-Thö thi chÕy", 7, x808081_g_CompleteMission_IDX )
	AddNumText( sceneId, x808081_g_ScriptId, "V« hoÕt ğµng Rùa-Thö thi chÕy", 11, x808081_g_MissionInfo_IDX )
...
function x808081_OnAbandon( sceneId, selfId )
  ...
  if HaveItem(sceneId, selfId, x808081_g_ItemId.id) > 0 then
  	if LuaFnGetAvailableItemCount(sceneId, selfId, x808081_g_ItemId.id) >= x808081_g_ItemId.num then
	  	...
	  	x808081_NotifyTip( sceneId, selfId, "V§t ph¦m cüa các hÕ hi®n không dùng ğßşc ho£c ğã b¸ khóa." )			
			return 0
  	end
  end
...
function x808081_OnSubmit( sceneId, selfId, targetId, selectRadioId )
	...
	--ÅĞ¶Ï¸ÃnpcĞúng·ñĞúng¶ÔÓ¦ÈÎÎñtoÕ ğµ npc
	if LuaFnGetName( sceneId, targetId ) ~= x808081_g_Name then
		x808081_NotifyTip( sceneId, selfId, "Trä nhi®m vø th¤t bÕi" )					
		return 0
	end
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x808081_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊıÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎï
end
