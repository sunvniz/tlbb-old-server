...
--x808064_g_strPieInfo1 = "ÖÐÇïÍÅÔ²,Ê®mµt »¶Çì,#c00ff00¡¶Thiên Long°Ë²¿¡·#WÌØ±ðÎªThiên LongÍæ¼Ò×¼±¸ÁËÍÅÔ²ºÃÀñ,´ÓÏÖTÕi Æðµ½10ÔÂ11ÈÕÎªÖ¹,10c¤pÒÔÉÏtoÕ ðµ Íæ¼ÒÃ¿Ìì¶¼¿ÉÒÔÀ´ÎÒÕâLînh mµt ´Î#c00ff00ÍÅÔ²»¶ÇìÔÂ±ý#WºÍ#c00ff00¹ð»¨ÔÂ±ý#W.Í¬Ê±·òÆÞ¹ØÏµ,½á°Ý¹ØÏµºÍÊ¦Í½¹ØÏµ»¹¿ÉÒÔ¶îÍâÔÙLînh mµt ´Î.#r"
--x808064_g_strPieInfo2 = "Cái này ½éÉÜÌ«³¤ÁË²ðµô·Å×ÖtoÕ ðµ Àï°É£....¡"
--x808064_g_strPlayerLvErr = "Ç×°®toÕ ðµ Íæ¼Ò,Çë´ïµ½10c¤pºóÔÙÀ´Lînh ."
--x808064_g_strNotSpace = "ÄútoÕ ðµ °ü¹üÃ»ÓÐ×ã¹»¿Õ¼ä,ÇëÕûÀíºóÔÙÀ´Lînh ."
--x808064_g_strTeamError2 = "ÇëÄúÓë°éÂÂµ¥¶À×é¶Ó,²¢È·ÈÏ¶Ô·½TÕi ÓÐÐ§·¶Î§ÄÚ²ÅÄÜLînh ."
--x808064_g_strTeamError3 = "ÇëÓëÄútoÕ ðµ ½á°Ý¹ØÏµÈË×é¶Ó,²¢È·ÈÏ¶Ô·½¶¼TÕi ÓÐÐ§·¶Î§ÄÚ²ÅÄÜLînh ."
--x808064_g_strTeamError4 = "ÇëÈ·ÈÏ¶Ó³¤ÐúngÊ¦¸µ,²¢ÇÒ¶ÓÎéÖÐtoÕ ðµ Í½µÜÈ«²¿Ðúng¶Ó³¤toÕ ðµ Í½µÜ,Ê¦¸µ»òÍ½µÜTÕi ÓÐÐ§·¶Î§ÄÚ²ÅÄÜLînh ."
--x808064_g_strGetPieInfo = "ÖÐÇïÍÅÔ²,Ê®mµt »¶Çì,×£ÄãÍòÊÂÈçÒâ,ÐÄÏëÊÂ³É.ÕâÁ½¿éÔÂ±ý¾Í ðßa cho ÄãÁË."
--x808064_g_strCannotToday1 = "²»ºÃÒâË¼,Äã½ñÌìÒÑ¾­Lînh ¹ý#c00ff00ÍÅÔ²»¶ÇìÔÂ±ý#WºÍ#c00ff00¹ð»¨ÔÂ±ý#WÁË."
--x808064_g_strCannotToday2 = "²»ºÃÒâË¼,Äã½ñÌìÒÑ¾­Lînh ¹ý·òÆÞ#c00ff00ÍÅÔ²»¶ÇìÔÂ±ý#WºÍ#c00ff00¹ð»¨ÔÂ±ý#WÁË."
--x808064_g_strCannotToday3 = "²»ºÃÒâË¼,Äã½ñÌìÒÑ¾­Lînh ¹ý½á°Ý#c00ff00ÍÅÔ²»¶ÇìÔÂ±ý#WºÍ#c00ff00¹ð»¨ÔÂ±ý#WÁË."
--x808064_g_strCannotToday4a = "²»ºÃÒâË¼,×÷ÎªÊ¦¸µ,Äú½ñÌìÒÑ¾­Lînh ¹ýÊ¦Í½#c00ff00ÍÅÔ²»¶ÇìÔÂ±ý#WºÍ#c00ff00¹ð»¨ÔÂ±ý#WÁË."
--x808064_g_strCannotToday4b = "²»ºÃÒâË¼,×÷ÎªÍ½µÜ,Äú½ñÌìÒÑ¾­Lînh ¹ýÊ¦Í½#c00ff00ÍÅÔ²»¶ÇìÔÂ±ý#WºÍ#c00ff00¹ð»¨ÔÂ±ý#WÁË."
...
function x808064_OnDefaultEvent( sceneId, selfId, targetId )
	...
	if NumText == 101 then
		...
		BeginEvent(sceneId)
			...
			--AddNumText(sceneId, x808064_g_ScriptId, "Ê²Ã´ÐúngÍÅÔ²»¶Çì»î¶¯?", 11, 705 )
		EndEvent(sceneId)
...
function x808064_GiveFuqiPie( sceneId, selfId, targetId )
	...
	--Ðúng·ñ2ÈË¶ÓÎé....²¢ÇÒÐµi viên È«²¿TÕi ¸½½ü....
...
function x808064_GiveJiebaiPie( sceneId, selfId, targetId )
	...
	--Ðúng·ñ2ÈË(º¬)ÒÔÉÏ¶ÓÎé....²¢ÇÒÐµi viên È«²¿TÕi ¸½½ü....
	local TeamSize = LuaFnGetTeamSize( sceneId, selfId )
	local NearTeamSize = GetNearTeamCount( sceneId, selfId )
	if TeamSize < 2 or TeamSize ~= NearTeamSize then
		BeginEvent(sceneId)
...
function x808064_GiveShituPie( sceneId, selfId, targetId )
	...
	--¶ÓÎéÐúng·ñÐµi viên È«Ðúng¶Ó³¤Í½µÜ....
	local OkTeam = 1
...
function x808064_GivePlayerPie( sceneId, selfId )
	...
	if BagIndex ~= -1 then
		--ÉèÖÃÎïÆ·ËùÓÐÕß....¹ð»¨ÔÂ±ý×Ô¼º²»ÄÜÓÃ....Ö»ÄÜ ðßa cho ±ðÈËÓÃ....ËùÒÔÒª¼ÇÂ¼ËùÓÐÕßtoÕ ðµ GUID....
