...
x894063_g_BOSSList =
{
	["XiaoYiFeng_NPC"]				= { DataID=15106, Title="Tiêu D§t Phong", posX=51, posY=53, Dir=27, BaseAI=3, AIScript=0, ScriptID=894070 },
	["XiaoYiFeng_BOSS"]				= { DataID=15110, Title="Tiêu D§t Phong", posX=51, posY=53, Dir=27, BaseAI=27, AIScript=301, ScriptID=894064 },
	...
	["XiaoRuJun_NPC"]		= { DataID=15126, Title="Tiêu Nhß Quân", posX=173, posY=36, Dir=0, BaseAI=3, AIScript=0, ScriptID=894071 },
	["XiaoRuJun_BOSS"]		= { DataID=15130, Title="Tiêu Nhß Quân", posX=173, posY=36, Dir=0, BaseAI=27, AIScript=0, ScriptID=894065 },
	["XiaoRuWei_NPC"]		= { DataID=15131, Title="Tiêu Nhß Quân", posX=173, posY=100, Dir=0, BaseAI=3, AIScript=0, ScriptID=894068 },
	["XiaoRuWei_BOSS"]		= { DataID=15135, Title="Tiêu Nhß Quân", posX=173, posY=100, Dir=0, BaseAI=27, AIScript=0, ScriptID=894067 },

	["ZhuBai_BOSS"]			= { DataID=15040, Title="Ð°ng Tâm Trúc - BÕch", posX=169, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=894080 },
	["ZhuHong_BOSS"]			= { DataID=15060, Title="Ð°ng Tâm Trúc - H°ng", posX=173, posY=32, Dir=0, BaseAI=28, AIScript=0, ScriptID=894083 },
	["ZhuHuang_BOSS"]			= { DataID=15050, Title="Ð°ng Tâm Trúc - Hoàng", posX=177, posY=36, Dir=0, BaseAI=28, AIScript=0, ScriptID=894082 },
	["ZhuLan_BOSS"]			= { DataID=15065, Title="Ð°ng Tâm Trúc - Lam", posX=176, posY=39, Dir=0, BaseAI=28, AIScript=0, ScriptID=894084 },
	["ZhuLv_BOSS"]			= { DataID=15055, Title="Ð°ng Tâm Trúc - Løc", posX=170, posY=33, Dir=0, BaseAI=28, AIScript=0, ScriptID=894085 },
	["ZhuZi_BOSS"]			= { DataID=15045, Title="Ð°ng Tâm Trúc - TØ", posX=173, posY=38, Dir=0, BaseAI=28, AIScript=0, ScriptID=894081 },

	["Bai_BOSS"]			= { DataID=15140, Title="Ð°ng Tâm Trúc - BÕch", posX=169, posY=100, Dir=0, BaseAI=28, AIScript=0, ScriptID=894086 },
	["Hong_BOSS"]			= { DataID=15160, Title="Ð°ng Tâm Trúc - H°ng", posX=173, posY=97, Dir=0, BaseAI=28, AIScript=0, ScriptID=894089 },
	["Huang_BOSS"]			= { DataID=15150, Title="Ð°ng Tâm Trúc - Hoàng", posX=177, posY=98, Dir=0, BaseAI=28, AIScript=0, ScriptID=894088 },
	["Lan_BOSS"]			= { DataID=15165, Title="Ð°ng Tâm Trúc - Lam", posX=176, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=894090 },
	["Lv_BOSS"]			= { DataID=15155, Title="Ð°ng Tâm Trúc - Løc", posX=175, posY=104, Dir=0, BaseAI=28, AIScript=0, ScriptID=894091 },
	["Zi_BOSS"]			= { DataID=15145, Title="Ð°ng Tâm Trúc - TØ", posX=173, posY=101, Dir=0, BaseAI=28, AIScript=0, ScriptID=894087 },

	["YeLvYan_NPC"]				= { DataID=15171, Title="Da Lu§t Di­m", posX=192, posY=195, Dir=27, BaseAI=3, AIScript=0, ScriptID=894072 },
	["YeLvYanLoss_NPC"]		= { DataID=14216, Title="", posX=117, posY=49, Dir=0, BaseAI=3, AIScript=0, ScriptID=894075 },
	["YeLvYan_BOSS"]			= { DataID=15175, Title="Da Lu§t Di­m", posX=192, posY=195, Dir=27, BaseAI=27, AIScript=0, ScriptID=894066 },
	...
	["LiFan_NPC"]				= { DataID=15186, Title="Da Lu§t Liên Thành", posX=52, posY=203, Dir=27, BaseAI=3, AIScript=0, ScriptID=894075 },
	["YeLvLian_BOSS"]		= { DataID=15190, Title="Da Lu§t Liên Thành", posX=52, posY=203, Dir=27, BaseAI=27, AIScript=0, ScriptID=894069 },
...
function x894063_OnDefaultEvent( sceneId, selfId, targetId )
	...
	BroadMsgByChatPipe( sceneId, selfId, "#cFF0000TÕi Binh Thánh KÏ Tr§n, anh hùng #gffff00"..nam.."#gff00f0 ðánh bÕi Gia Lu§t Liên Thành", 4 )
...
function x894063_OnEnumerate( sceneId, selfId, targetId )
	...
	AddNumText( sceneId, x894063_g_ScriptId, "Binh thánh kÏ tr§n (Khó)", 3, 10 )
...
function x894063_CheckCanEnter( sceneId, selfId, targetId )
	...
	if GetTeamSize(sceneId,selfId) < 3 then
		return 0, "C¥n mµt t± ðµi ít nh¤t 3 thành viên m¾i có th¬ tham gia!"
	end
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. " thành viên chßa ðü c¤p 120"
		return 0, msg
	...
	if nHumanNum > 0 then
		...
		msg = msg .. Humanlist[nHumanNum-1] .. "thành viên hôm nay ðã khiêu chiªn quá 3 l¥n"
		return 0, msg
