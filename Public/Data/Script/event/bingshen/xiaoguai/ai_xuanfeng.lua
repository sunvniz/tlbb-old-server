...
--ÃâÒßBuff....
x894096_Buff_MianYi1	= 10472	--ÃâÒßÒ»Ğ©¸ºÃæĞ§¹û....
x894096_Buff_MianYi2	= 10471	--ÃâÒßÆÕÍ¨ÒşÉí....
...
x894096_MyName			= "Tiêu Nhß Quân"	--×Ô¼ºµÄÃû×Ö....
x894096_BrotherName			= "Ğ°ng Tâm Trúc - BÕch"	--×Ô¼ºµÄÃû×Ö....

--AI Index....
x894096_IDX_KuangBaoMode	= 1	--¿ñ±©Ä£Ê½....0Î´¿ñ±© 1ĞèÒª½øÈë¿ñ±© 2ÒÑ¾­½øÈë¿ñ±©
x894096_IDX_CD_SkillFH		= 2	--FH¼¼ÄÜµÄCD....
x894096_IDX_CD_SkillG			= 3	--G¼¼ÄÜµÄCD....
x894096_IDX_CD_Talk				= 4	--FH¼¼ÄÜº°»°µÄCD....
x894096_IDX_CD_SkillI			= 5	--G¼¼ÄÜµÄCD....

x894096_IDX_CombatFlag 		= 1	--ÊÇ·ñ´¦ÓÚÕ½¶·×´Ì¬µÄ±êÖ¾....
...
function x894096_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x894096_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Thi phóng ğích thÑ trúc hãm t¸nh sinh vu túc hÕ, hoàn thïnh chß v¸ t¯c t¯c ğóa t¸." )
...
function x894096_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction((200060), "Paopao",sceneId, "Tiêu Nhß Quân", "Binh thánh kÏ tr§n", "Tiêu Nhß Quân: ğ°ng tâm løc trúc, nghênh phong nhi l§p, ngñ ngã thân khu, vi ngã hµ th¬, hßu dßŞng sinh tÑc, ph¤n lñc sát ğ¸ch." )
		CallScriptFunction( x894096_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Phát ğµng hßu dßŞng sinh tÑc chi thu§t. Thø ğ°ng tâm trúc tß½ng trş, huynh ğ® nh¸ nhân giai dî mi­n d¸ch thß½ng hÕi. Nhßşc nång phá trúc, t¡c ğ¯i Ñng phòng ngñ khä b¸ mi­n tr×." )
...
function x894096_OnImpactFadeOut( sceneId, selfId, impactId )
	...
	if impactId == 19413 then
		...
		CallScriptFunction( x894096_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Huynh ğ® ğ°ng tâm, kì lñc ğoÕn kim. . . . . . Do vu v¸ tÕi 30 mi¬u nµi toàn di®t tiêu th¸ ğ® huynh, tiêu nhß úy hi®n dî phøc sinh. . . . . . ." )
