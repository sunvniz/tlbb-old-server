...
function x894080_OnDie( sceneId, selfId, killerId )
	...
	CallScriptFunction( x894080_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân s· hoán #c2ebeff"..GetName( sceneId, selfId ).." dî b¸ kích phá, cách ngÕn ð°ng s¡c chi trúc dî vô pháp t°i hüy." )
...
function x894080_UseSkillG( sceneId, selfId )
	...
	CallScriptFunction( x894080_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Thi phóng ðích thÑ trúc hãm t¸nh sinh vu túc hÕ, hoàn thïnh chß v¸ t¯c t¯c ðóa t¸." )
...
function x894080_UseSkillH( sceneId, selfId )
		...
		CallScriptFunction( x894080_g_FuBenScriptId, "TipAllHuman", sceneId, "Tr¥n Dûng Nhân nói:  Tiêu Nhß Quân Phát ðµng hßu dßÞng sinh tÑc chi thu§t. Thø ð°ng tâm trúc tß½ng trþ, huynh ð® nh¸ nhân giai dî mi­n d¸ch thß½ng hÕi. Nhßþc nång phá trúc, t¡c ð¯i Ñng phòng ngñ khä b¸ mi­n tr×." )
