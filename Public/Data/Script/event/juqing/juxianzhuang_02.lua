...
x200021_g_MissionComplete="  $N, sñ giúp ðÞ cüa các hÕ, Ki«u m² ta cäm kích vô cùng. Vào bu±i sáng ngày mai, chúng ta s¨ g£p lÕi tÕi Ðông môn cüa thành LÕc Dß½ng!"	--Hoàn t¤t nhi®m vønpcËµ»°toÕ ðµ »°
...
function x200021_OnAccept( sceneId, selfId )
	...
	Msg2Player(  sceneId, selfId,"#YNh§n nhi®m vø: Ðïnh thiên l§p ð¸a",MSG2PLAYER_PARA )
...
function x200021_OnSubmit( sceneId, selfId, targetId,selectRadioId )
	if x200021_CheckSubmit(sceneId, selfId) == 1  then
  	...
  	BeginAddItem(sceneId)
		...
		Msg2Player(  sceneId, selfId,"#YHoàn t¤t nhi®m vø: Ðïnh thiên l§p ð¸a",MSG2PLAYER_PARA )
