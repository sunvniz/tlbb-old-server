--001231
--´Ó»ªÉ½ÂÛ½£»Øµ½¸÷×ÔtoÕ ğµ ÃÅÅÉ³¡¾°,¾ÍÒÀ¿¿ÎÒÁË.
...
function x001231_OnDefaultEvent( sceneId, selfId, targetId )
	if GetNumText() == 0   then
		...
		elseif nMempai == 9    then
			...
			nPos_X			 = 191
			nPos_Z			 = 138
			--PrintStr("ÄãCái này ¼mµt ï,±»ÈËKtoÕ ğµ ¶¼²»ÖªµÀ×Ô¼ºÃÅÅÉÁË???")
		end
		
		CallScriptFunction((400900), "TransferFunc",sceneId, selfId, nMenpaiScene, nPos_X, nPos_Z)
		
		-- µ±ÕâÀïÓĞÈËÀë¿ª,Èç¹ûÊ±¼ä»¹TÕi ¿ÉÒÔ±¨ÃûtoÕ ğµ Ê±¼ä,ÄÇÃ´Í¨Öª±¨Ãû¹ÜÀíÔ±
