...
--ÈÎÎñÐúng·ñÒÑ¾­Íê³É
x250026_g_IsMissionOkFail = 0		--±äÁ¿toÕ ðµ µÚ0Î»

x250026_g_PetDataID=3250	--ÈÎÎñÕäÊÞtoÕ ðµ ±àºÅ
--ÒÔÉÏÐúng¶¯Ì¬**************************************************************
...
x250026_g_MissionTarget="Bang Vân Hán Nhi tìm ðßþc 1 con Kh±ng Tß¾c. "		--Møc tiêu nhi®m vø
x250026_g_ContinueInfo="Các hÕ b¡t ðßþc Kh±ng Tß¾c chßa?"		--Î´Hoàn t¤t nhi®m vøtoÕ ðµ npc¶Ô»°
x250026_g_MissionComplete="Làm t¯t l¡m. "					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ðµ »°
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x250026_OnDefaultEvent( sceneId, selfId, targetId )	-- ði¬m»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
	--Èç¹ûÒÑ½Ó´ËÈÎÎñ
...
function x250026_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250026_GetTimePass( sceneId, selfId ) ) then      
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x250026_g_MissionId)			-- ði¬mµ½ÈÎÎñtoÕ ðµ ÐòÁÐºÅ
	SetMissionByIndex(sceneId,selfId,misIndex,0,0)						--¸ù¾ÝÐòÁÐºÅ°ÑÈÎÎñ±äÁ¿toÕ ðµ µÚ0Î»ÖÃ0 (ÈÎÎñÍê³ÉÇé¿ö)
	SetMissionByIndex(sceneId,selfId,misIndex,1,x250026_g_ScriptId)						--¸ù¾ÝÐòÁÐºÅ°ÑÈÎÎñ±äÁ¿toÕ ðµ µÚ1Î»ÖÃÎªÈÎÎñ½Å±¾ºÅ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x250026_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊýÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
