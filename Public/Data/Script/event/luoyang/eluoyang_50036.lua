...
--ÈÎÎñÏÞÊ±
x250036_g_MissionLimitTime = 60 * 60 * 1000; --ºÁ giây
...
x250036_g_MissionTarget="M¶i ðªn LÕc Dß½ng g£p HÖ Lai LÕc #{_INFOAIM177,94,0, HÖ Lai LÕc} s¡p xªp tu¥n du b¢ng xe hoa.";		--Møc tiêu nhi®m vø
...
x250036_g_eventId_begin = 0;	-- ði¬m»÷»¨³µÑ²ÓÎÈÎÎñtoÕ ðµ ÊÂ¼þ
x250036_g_eventId_start = 1;	-- ði¬m»÷¿ªÊ¼Ñ²ÓÎtoÕ ðµ ÊÂ¼þ
x250036_g_eventId_close = 2;	-- ði¬m»÷µÈ»áÔÙ¿ªÊ¼toÕ ðµ ÊÂ¼þ

x250036_g_busDataIds = {3, 4, 5};	--»¨³µtoÕ ðµ DataID
...
function x250036_OnAccept(sceneId, selfId, marryLevel)
	...
	misIndex = GetMissionIndexByID(sceneId, selfId, x250036_g_MissionId);			-- ði¬mµ½ÈÎÎñtoÕ ðµ ÐòÁÐºÅ
