...
--ÈÎÎñÐúng·ñÒÑ¾­Íê³É
x250010_g_IsMissionOkFail = 0		--±äÁ¿toÕ ðµ µÚ0Î»

x250010_g_PetDataID=3090	--ÈÎÎñÕäÊÞtoÕ ðµ ±àºÅ
--ÒÔÉÏÐúng¶¯Ì¬**************************************************************
...
x250010_g_MissionTarget="Bang Vân Hán Nhi tìm ðßþc 1 con Thanh Oa. "		--Møc tiêu nhi®m vø
x250010_g_ContinueInfo="Các hÕ b¡t ðßþc Thanh Oa chßa?"		--Î´Hoàn t¤t nhi®m vøtoÕ ðµ npc¶Ô»°
x250010_g_MissionComplete="Làm t¯t l¡m. "					--Hoàn t¤t nhi®m vønpcËµ»°toÕ ðµ »°
...
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x250010_OnDefaultEvent( sceneId, selfId, targetId )	-- ði¬m»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
	--Èç¹ûÒÑ½Ó´ËÈÎÎñ
...
function x250010_OnAccept( sceneId, selfId )
  ...
  if( 0 == x250010_GetTimePass( sceneId, selfId ) ) then      
	...
	misIndex = GetMissionIndexByID(sceneId,selfId,x250010_g_MissionId)			-- ði¬mµ½ÈÎÎñtoÕ ðµ ÐòÁÐºÅ
	SetMissionByIndex(sceneId,selfId,misIndex,0,0)						--¸ù¾ÝÐòÁÐºÅ°ÑÈÎÎñ±äÁ¿toÕ ðµ µÚ0Î»ÖÃ0 (ÈÎÎñÍê³ÉÇé¿ö)
	SetMissionByIndex(sceneId,selfId,misIndex,1,x250010_g_ScriptId)						--¸ù¾ÝÐòÁÐºÅ°ÑÈÎÎñ±äÁ¿toÕ ðµ µÚ1Î»ÖÃÎªÈÎÎñ½Å±¾ºÅ
...
--É±ËÀ¹ÖÎï»òÍæ¼Ò
--**********************************
function x250010_OnKillObject( sceneId, selfId, objdataId ,objId)--²ÎÊýÒâË¼: ³¡¾°ºÅ¡¢Íæ¼ÒobjId¡¢¹ÖÎï±íÎ»ÖÃºÅ¡¢¹ÖÎïobjId
end
