...
x250038_g_eventId_updateJoinList = -1;				-- Ë¢ÐÂÄÜ¼ÓÈëtoÕ ðµ ÁÐ±í(Òª±£Ö¤´ËÖµ²»»áÓëÍæ¼ÒtoÕ ðµ GUIDÏàÍ¬)

x250038_g_invitationDataId_level1  = 30303100;		-- ÆÕÍ¨ÇëÌûID
x250038_g_invitationDataId_level2  = 30303101;		-- ¸ßc¤pÇëÌûID
x250038_g_invitationDataId_level3  = 30303102;		-- ºÀ»ªÇëÌûID

--**********************************
--ÈÎÎñÈë¿Úº¯Êý
--**********************************
function x250038_OnDefaultEvent(sceneId, selfId, targetId)	-- ði¬m»÷¸ÃÈÎÎñºóÖ´ÐÐ´Ë½Å±¾
